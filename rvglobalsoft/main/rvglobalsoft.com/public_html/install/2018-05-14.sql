...
UNION SELECT id, 'configuration', 'MergeDomainRenewals','Issue invoice for domain renewal sooner, if customer have invoice for other services issued in renewal month' FROM hb_language WHERE target='admin'
