            ...
            <table width="100%" cellspacing="0" cellpadding="5" border="0">
                <tbody><tr>
                        <td width="120" valign="top"><div style="padding:10px 0px;">
                                <a  class="sorter-ha menuitm menuf" href="?cmd=module&module={$moduleid}&do=floors&colo_id={$colo.id}"><span >Floors</span></a><!--
                                --><a style="width:14px;" title="Edit" class="menuitm menuc" href="?cmd=module&module={$moduleid}&do=floors&colo_id={$colo.id}" onclick="return editColocation('{$colo.id}')"><span class="editsth"></span></a><!--
                                --><a  onclick="return confirm('Are you sure you want to delete this colocation?');" title="delete" class="menuitm menul" href="?cmd=module&module={$moduleid}&do=removecolo&colo_id={$colo.id}"><span class="delsth"></span></a>
                            </div></td>
