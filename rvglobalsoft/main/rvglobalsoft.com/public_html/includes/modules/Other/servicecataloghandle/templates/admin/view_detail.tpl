        ...
        <li style="border:none;">
            ...
            <div>
                ...
                $(document).ready(function () {
                    ...
                    CKFinder.setupCKEditor( CKEDITOR.instances.serviceDetail , '/7944web/templates/default/js/ckfinder');
                });
        ...
        <li style="border:none; color: red;">
            ...
            <div>
                ...
                $(document).ready(function () {
                    ...
                    CKFinder.setupCKEditor( CKEDITOR.instances.requestPermission , '/7944web/templates/default/js/ckfinder');
                });
                {/literal}
                </script>
            </div>
        ...
        <li style="border:none;">
            ...
            <div>
                ...
                $(document).ready(function () {
                    ...
                    CKFinder.setupCKEditor( CKEDITOR.instances.requestOrder , '/7944web/templates/default/js/ckfinder');
                });
                {/literal}
                </script>
            </div>
        ...
        <li style="border:none;">
            ...
            <div>
                ...
                $(document).ready(function () {
                    ...
                    CKFinder.setupCKEditor( CKEDITOR.instances.orderTimeAvailable , '/7944web/templates/default/js/ckfinder');
                });
                {/literal}
                </script>
            </div>
        ...
        <li style="border:none;">
            ...
            <div>
                ...
                $(document).ready(function () {
                    ...
                    CKFinder.setupCKEditor( CKEDITOR.instances.priceRate , '/7944web/templates/default/js/ckfinder');
                });
                {/literal}
                </script>
            </div>
        ...
        <li style="border:none;">
            ...
            <div>
                ...
                $(document).ready(function () {
                    ...
                    CKFinder.setupCKEditor( CKEDITOR.instances.serviceRelated , '/7944web/templates/default/js/ckfinder');
                });
                {/literal}
                </script>
            </div>
        ...
        <li style="border:none;">
            ...
            <div>
                ...
                $(document).ready(function () {
                    ...
                    CKFinder.setupCKEditor( CKEDITOR.instances.servicePolicy , '/7944web/templates/default/js/ckfinder');
                });
                {/literal}
                </script>
            </div>
        ...
        <li style="border:none;">
            ...
            <div>
                ...
                $(document).ready(function () {
                    ...
                    CKFinder.setupCKEditor( CKEDITOR.instances.warrantyRate , '/7944web/templates/default/js/ckfinder');
                });
                {/literal}
                </script>
            </div>
