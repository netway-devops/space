...
class cc_modify extends OtherModule
{
    ...
    const NAME = 'credit card modify';

    protected $filename='class.cc_modify.php';
    protected $description='';
    protected $modname = 'RV Global Soft Credit Card Modify';
