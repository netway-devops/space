...
class kbongoogle extends OtherModule {
    
    protected $modname      = 'Knowledgebase on Google Drive';
    protected $description  = 'Knowledgebase syncronize from google drive to hostbill automatically by netway<br />
