...
var fndirect=function() {
  $('body').append('<div id="jixedbar">'
     + '<ul><li title="How to use this plugin"><a href="http://blog.hostbillapp.com/2011/10/03/direct-order-link-plugin-few-updates-from-hostbill-dev-team/" target="_blank"><img src="templates/default/img/information-white.png" alt="" /></a></li></ul>'
      +  '<span class="jx-separator-left"></span>'
		+'<ul><li title="Dump current cart contents into re-usable link"><a href="#" id="generate_link"><img src="includes/types/onappcloud/images/block--plus.png" alt="Generate direct link" /></a></li></ul>'
       + '<span class="jx-separator-left"></span>'
