<div id="newshelf">
    <a href="?cmd=module&module={$module_id}" class="tchoice {if $action != 'showlog'}picked{/if}">Configuration</a>
    <a href="?cmd=module&module={$module_id}&act=showlog" class="tchoice {if $action == 'showlog'}picked{/if}">Show Log</a>
</div>
            ...
            <table cellpadding="6" cellspacing="0">
                ...
                <tr> 
                    <td colspan="2">
                        ...
                        Use this plugin to automatically create DNS zones for domains having nameservers specified below
                        <div>
                        <ul class="treeview eventtree left" style="padding-left:3px; {if $submit.autozone == 0}display:none{/if}">
                            <li style="padding-top:1px"><label><input type="radio" name="autozone" {if $submit.autozone == '1'}checked="checked"{/if} value="1" /> Before domain registration</label></li>
                            <li class="last" style="padding-top:1px"><label><input type="radio" name="autozone" {if $submit.autozone == '2'}checked="checked"{/if} value="2" /> After successful domain registration</label></li>
                        </ul>
                    ...
                    <td>{$lang.Username}</td><td><input name="username" value="{$submit.username}" size="20" class="inp" /> 
                        <span style="margin-left: 30px">
                            <a onclick="testConfiguration() ;return false;" id="testing_button" href="#" class="new_control">
                                <span class="wizard">Test Configuration</span>
                            </a>
                        </span>
