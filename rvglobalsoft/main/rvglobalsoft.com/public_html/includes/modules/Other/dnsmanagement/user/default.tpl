...
<br />
{if $act=="editdomain"}
<a href="?cmd=module&amp;module={$module_id}" style="font-weight: bold">&laquo; Return</a>
            ...
            {if $dnsentries}
                {foreach from=$dnsentries item=entry key=line}
					<tr>{if $entry.type == 'SOA'}
						...
						&nbsp;&nbsp;&nbsp;&nbsp;{$entry.data.serial}; Serial<br />
						&nbsp;&nbsp;&nbsp;&nbsp;{$entry.data.refresh}; Refresh<br />
						&nbsp;&nbsp;&nbsp;&nbsp;{$entry.data.retry}; Retry<br />
						&nbsp;&nbsp;&nbsp;&nbsp;{$entry.data.expire}; Expire<br />
						&nbsp;&nbsp;&nbsp;&nbsp;{$entry.data.minimum} ); Minimum TTL<br />
...
{elseif $act=='default'}
    ...
    {else}
        <p style="text-decoration: italic; text-align: center">No domain entries found</p>
    {/if}
{/if}	
