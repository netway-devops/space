<div class="ipamleft">
    <form action="" method="post" id="ipamleftform">
        <div id="ipamsearch">
            <input type="text" value="{$searchterm}" name="stemp" autocomplete="off" /><button onclick="$(this).prev().val('').keyup()"><img src="{$plugin_dir}/img/bimg.png" alt="clear" title="Clear" /></button>
        </div>
        <div id="ipamsearch_filters">
...
<div id="ipamright">
    {if $action == 'default' || $action == 'dellist' || !$action}
    {if !$group.id}
