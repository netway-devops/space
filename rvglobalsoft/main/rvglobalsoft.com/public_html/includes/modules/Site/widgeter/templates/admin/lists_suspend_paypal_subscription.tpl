...
<tr>
	...
	<div id="bodycont"> 
		...
		<table cellspacing="0" cellpadding="3" border="0" width="100%" class="glike hover table">
        <tbody>
            <tr>
                <th width="180">Date</th>
                <th width="180">Account ID</th>
				<th width="180">Invoice ID</th>
				<th width="180">Transaction ID</th>
				<th width="180">Paypal Transaction ID</th>
				<th width="180">Paypal Subscription ID</th>
				<th width="180">Pay to Account</th>
                <th align="center" width="150">Action</th>
            </tr>
        </tbody>
        <tbody id="updater">
            {include file="$tplPath/admin/ajax.lists_suspend_paypal_subscription.tpl"}
        </tbody>
        <tbody id="psummary">
            <tr>
                <th colspan="7">
