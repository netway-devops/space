...
<tr>
    ...
    <div id="bodycont"> 
        ...
        <div class="search" style="background-color: #bbb;">
            <input id="filter" type="text" style="background-color: #cfcfcf;" placeholder="Search..." size="50"/>
        </div>
        ...
        <tbody>
            <tr>
                ...
                <th align="center" width="10%"><div align="center">Order ID</div></th>
                <th align="center" width="10%"><div align="center">Product ID</div></th>
                <th align="center" width="10%"><div align="center">Product Type</div></th>
                <th align="center" width="10%"><div align="center">Expiry Date</div></th>
                <th align="center" width="10%"><div align="center">Status</div></th>
                <th align="center" width="35%"><div align="center">Certificate Name</div></th>
                <th align="center" width="10%"><div align="center">Action</div></th>
            </tr>
        </tbody>
        <tbody id="updater">
            {include file="$tplPath/admin/ajax.lists_rvtwofactorterminatedaccount.tpl"}
        </tbody>
        <!--
        <tbody id="psummary">
            <tr>
