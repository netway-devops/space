...
-----------------------------------
    ...
    public function getLastreplyTime ($request)
    {
        $db             = hbm_db();
        $aTickets       = isset($request['aTickets']) ? $request['aTickets'] : array();
        ...
        $aTicketId      = array();
        $aKey           = array();
        foreach ($aTickets as $k => $arr) {
            array_push($aTicketId, $arr['id']);
            $aKey[$arr['id']]   = $k;
        }
        ...
        foreach ($result as $arr) {
            $id         = $arr['id'];
            $key        = $aKey[$id];
            $aTickets[$key]['lastreplyDate']    = $arr['lastreply'];
        }
