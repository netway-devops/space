...
class softaculouslicensehandle_controller extends HBController 
{
    protected $moduleName = 'softaculouslicensehandle';
    ...
    public function changeip ($params) 
    {
        ...
        $oHandle    = softaculouslicensehandle::singleton();
        $oHandle->connect(array());
        
        $result     = $oHandle->noc->licenses('', $oldIp);
        ...
        $result     = $oHandle->noc->editips($licenseId, $ip);
