            ...
            <div style="margin:0 5px 5px 0">
                ...
                <div class="sectionbody" style="padding:10px;">
                    <div>
                        ...
                        <input type="radio"  name="options[soaemailclient]" value="1" {if $default.soaemailclient=='1'}checked="checked"{/if} /> Use client email address <br />
                        <input type="radio"  name="options[soaemailclient]" value="0" {if $default.soaemailclient!='1'}checked="checked"{/if} /> Use email address below:
