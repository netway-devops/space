...
class ZabbixApi extends ZabbixApiAbstract {
    ...
    public function getUserIdByUserAlias($userAlias="") {
        ...
        return (isset($aRes[0]->userid)) ? $aRes[0]->userid : null;
    }
     ...
     * @param $imageDest
     */
    public function getGraphImage($url="", $user="", $password="", $hostName="", $graphId="", $period="", $imageDest="") {
        ...
        return "includes/modules/Hosting/zabbix/public_html/images/tmp/" . $hostName . "_" . $graphId . ".png";
    }
