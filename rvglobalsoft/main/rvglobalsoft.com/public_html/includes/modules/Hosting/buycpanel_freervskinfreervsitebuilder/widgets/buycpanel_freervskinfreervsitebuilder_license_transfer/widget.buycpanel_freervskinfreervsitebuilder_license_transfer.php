...
class widget_buycpanel_freervskinfreervsitebuilder_license_transfer extends HostingWidget
{
    ...
    public function clientFunction(&$module) 
    {
        ...
        return array(
			"buycpanel_freervskinfreervsitebuilder_transfer.tpl"
			, array(
				'acc_id' => $aAccountDetails['id'],
				'frm_ip' => $aIp['data'],
				'cmd' => 'buycpanel_freervskinfreervsitebuilder',
