						...
						<tr>
							...
							<tr class="lastone ">
								<td colspan="4" style="text-align: right">
									...
									<input type="submit" value="Resend Approve Email" name="submit" style="font-weight:bold" class="padded" onclick="$('#edo').val('sendmail')"/>
									{/if}
									{if $status.state=='active' || $status.state=='compleated'}
									<input type="submit" value="Resend Certificate Email" name="submit" style="font-weight:bold" class="padded" onclick="$('#edo').val('resendcert')"/>
									{/if}
									{if $status.is_renewable=='1'}
									<input type="submit" value="Renew" name="submit" style="font-weight:bold" class="padded" onclick="$('#edo').val('renew')"/>
									{/if}
									<input type="submit" value="Synchronize" name="submit" style="font-weight:bold" class="padded" onclick="$('#edo').val('Synchronize')"/>
