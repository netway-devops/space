        ...
        <div style="margin:5px 0px 10px">
            <table border="0" cellspacing="0" cellpadding="3">
                <tr><td>{$lang.firewallrule} ({$int.label}): </td>
                    <td style="padding-left:10px"><div id="frule_{$int.label}"><b>{$int.default}</b> <a href="#" onclick="$('#frule_{$int.label}').hide();
                            $('#frule_{$int.label}_e').show();
                            return false" class="fs11">{$lang.edit}</a></div>
...
<div class="right" style="margin:5px;"><a style="font-size:12px" onclick="$('#formapplyrules').submit();
                            return false" class="small_control small_save" href="#"><b>{$lang.applyfirewall}</b></a></div>
<div class="clear"></div>
