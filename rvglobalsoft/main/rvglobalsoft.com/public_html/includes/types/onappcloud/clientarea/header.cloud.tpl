...
<div id="nav-onapp">
    ...
    <ul class="level-1">
        ...
        <li  id="resourcestab" class="{if $vmsection=='resources'}current-menu-item{/if}"><a href="?cmd=clientarea&action=services&service={$service.id}&vpsdo=resources"><span class="resources">{$lang.reslabel}</span></a></li>
