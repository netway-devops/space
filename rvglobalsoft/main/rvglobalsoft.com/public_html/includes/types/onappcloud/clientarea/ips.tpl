...
<div style="padding:10px 0px;text-align:right">
    ...
    <span class="text">{$lang.freeipleft1} <b>{$allowaddingip[1]}</b> {$lang.freeipleft} 
        <i style="font-size:11px">{if $allowaddingip[1] || $allowaddingip[2]}( {if $allowaddingip[1]}public: {$allowaddingip[1]} {/if} 
        {if $allowaddingip[2]}private: {$allowaddingip[2]} {/if} ){/if}</i>
