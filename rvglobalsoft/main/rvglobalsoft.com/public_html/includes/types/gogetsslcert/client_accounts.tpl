							...
							<tbody>
								<tr>
									...
									<td style="text-align: center" colspan="4">
										<a href="{$ca_url}clientarea&action=services&service={$service.id}&edo=editOrg" style="color:red; ">Edit your Organization details</a>
									</td>
								</tr>
							</tbody>
						{/if}
					...
					{else}
						<tbody>
							<tr>
								...
								<td style="text-align: center" colspan="4">
									<a href="{$ca_url}clientarea&action=services&service={$service.id}&edo=editContacts" style="color:red; ">Edit your Contacts details</a>
								</td>
							</tr>
						</tbody>
					{/if}
			...
			<div class="wbox">
				...
				<div class="wbox_content">
					<table width="100%" cellspacing="0" cellpadding="0" border="0" class="checker table table-striped">
						<tr>
							<td>Status:</td>
							<td><span class="label label-Active">{$status.state|capitalize}</span></td>
							<td>Certification Periods:</td>
						...
						<tr>
							...
							<tr class="lastone ">
								<td colspan="4" style="text-align: right">
									...
									<input type="submit" value="Download Certificate" name="submit" style="font-weight:bold" class="btn padded btn-success" onclick="$('#edo').val('resendcert')"/>
									<input type="submit" value="Download CA Bundle" name="submit" style="font-weight:bold" class="btn padded btn-success" onclick="$('#edo').val('resendca')"/>
									{/if}
									{if $status.is_renewable=='1'}
									<input type="submit" value="Renew" name="submit" style="font-weight:bold" class="btn padded" onclick="$('#edo').val('renew')"/>
									{/if}
									<input type="submit" value="Synchronize" name="submit" style="font-weight:bold" class="btn padded btn-info" onclick="$('#edo').val('Synchronize')"/>
