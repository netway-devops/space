...
<div id="nav-onapp">
    ...
    {else}
        ...
        <ul class="level-1">
            ...
            {if $network_overview}
                <li class="{if $vmsection=='network'}current-menu-item{/if}"><a href="?cmd=clientarea&action=services&service={$service.id}&vpsdo=ips"><span class="resources">{$lang.networkzone}</span></a></li>
            {/if}
