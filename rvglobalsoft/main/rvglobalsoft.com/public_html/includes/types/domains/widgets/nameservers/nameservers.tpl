                    ...
                    {foreach from=$details.nameservers item=nameserver key=number name=nsloop}
                        <tr class="nsrow {if $smarty.foreach.nsloop.iteration%2==0}even{/if}">
                            ...
                            <td >
                                ...
                                {if $smarty.foreach.nsloop.last && ($number+1) != 10}<a class="add_ns" style="font-size: 11px;" href="#" onclick="add_ns(this); return false;">Add more</a>{/if}
                            </td>
                        </tr>
                    ...
                    {foreach item=i from=1|@range:10 name=mnsloop}
                        <tr class="nsrow  even">
                            ...
                            <td ><input type="text" class="styled" size="40" data-id="{$i}" value="" name="nameservers[ns{$i}]" class="styled todisable"/>
                                {if $smarty.foreach.mnsloop.last && $i != 10}<a class="add_ns" href="#" style="font-size: 11px;" onclick="add_ns(this); return false;">Add more</a>{/if}
                            </td></tr>
                    {/foreach}
                    {/if}
