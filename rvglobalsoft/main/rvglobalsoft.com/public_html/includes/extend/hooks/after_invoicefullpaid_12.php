 ...
 */
 ...
 /**
  * ตรวจสอบว่าถ้าเป็น paypal payment payment@rvglobalsoft.com
  * แสดง่วาจ่ายให้ netway ต้อง update field is_netway
  */
...
invoicehandle_controller::singleton()->checkPayToNetway($invoiceId);
