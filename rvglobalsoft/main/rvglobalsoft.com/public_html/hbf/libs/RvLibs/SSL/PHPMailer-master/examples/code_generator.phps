...
$mail = new PHPMailerNew(true);  //PHPMailer instance with exceptions enabled
$mail->CharSet = 'utf-8';
$mail->Debugoutput = $CFG['smtp_debugoutput'];
$example_code .= "\n\n\$mail = new PHPMailerNew(true);";
$example_code .= "\n\$mail->CharSet = 'utf-8';";

class phpmailerAppException extends phpmailerExceptionNew
{
}
...
try {
    if (isset($_POST["submit"]) && $_POST['submit'] == "Submit") {
        ...
        } catch (phpmailerExceptionNew $e) { //Catch all kinds of bad addressing
