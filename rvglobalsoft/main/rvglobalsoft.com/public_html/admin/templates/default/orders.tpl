...
include($templatePath . 'orders.tpl.php');
{/php}
            ...
            <div class="blu">
                ...
                <div class="left menubar">
                    ...
                    <ul id="hd1_m" class="ddmenu">
                        ...
                        <li class="{if ! isset($admindata.access.editOrders)}isForbidAccess{/if}" ><a href="MarkFraud" onclick="$('#markasfraud1').click();">{$lang.setasfraud}</a></li>
                    </ul>
