...
<table border="0" cellpadding="0" cellspacing="0" width="100%" >
    ...
    <tr>
        ...
        <td  valign="top" id="dashboard-table">
            ...
            <div class="bborder">
                <div class="bborder_header">Widget</div>
                ...
                <ul class="widgetBox300s">
                    ...
                    <li id="{$widget}">
                        <a href="?cmd=widgeter&action=lists&widget={$widget}" target="_blank">
                            <label>0</label>
                            <span>Loading...</span>
                        </a>
                    </li>
                    ...
                    {literal}
                        $.getJSON('?cmd=widgeter&action=counter&widget={/literal}{$widget}{literal}', function(data) {
