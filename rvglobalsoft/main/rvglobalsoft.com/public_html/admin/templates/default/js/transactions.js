...
$(function () {
    ...
    function importItems(items_cb) {
        ...
        if (ifloat > 0 && fin > ifloat) {
            msg.push('Amount in cannot be higher than Total Amount in');
        }
        if(ofloat > 0 && fout > ofloat) {
            msg.push('Amount in cannot be higher than Total Amount out');
        }
