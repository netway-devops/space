<?php
require(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))) .'/includes/hostbill.php');
...
$baseUrl    = (preg_match('/hostbill/', $_SERVER['SERVER_NAME'])) ? 'http://' : 'https://';
$baseUrl    .= $_SERVER['SERVER_NAME'];
$baseDir    = dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))));
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => $baseUrl .'/uploads/kb/',
    'root'         => $baseDir .'/uploads/kb/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
