<div class="newhorizontalnav" id="newshelfnav">
    ...
    <ol class="breadcrumb">
        ...
        {foreach from=$category.breadcrumbs item=item}
            <li class="breadcrumb-item"><a href="?cmd={$cmd}&cid={$item.id}">{$item.name}</a></li>
        {/foreach}
        <li class="breadcrumb-item active"><a href="?cmd={$cmd}&cid={$category.id}"><strong>{$category.name}</strong></a></li>
    </ol>
</div>
{literal}
    <style>
