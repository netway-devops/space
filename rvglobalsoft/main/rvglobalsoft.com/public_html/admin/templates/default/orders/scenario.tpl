...
<div style="margin:10px 0px;" id="tabcontainer">
    ...
    <div id="tabs_order" style="margin-top:-1px;border: solid 1px #DDDDDD;padding:10px;background:#fff" class="{if ! isset($admindata.access.editOrders)}isForbidAccess{/if}">
