...
<form action="" method="post" >
    <input type="hidden" value="update" name="make" {if ! isset($admindata.access.editTransactions)}onsubmit="return false;"{/if}> />
    <div class="blu">
        ...
        <div class="ticketmsg ticketmain" id="client_tab">
            <div class="slide" style="display:block">
                ...
                <div id="detcont " >
                        ...
                        <div class="form-group col-sm-3 col-md-3" >
                            ...
                            <div class="input-group searchform" style="width: 100%;">
                                <div class="datepicker">
                                    <input type="text" value="{$transaction.date|dateformat:$date_format}" name="date" class="form-control haspicker" readonly="readonly" />
                                </div>
                            </div>
                        </div>
                            ...
                            {else}
                                ...
                                <table cellspacing="0" cellpadding="3" border="0" width="100%" class="table glike">
                                    ...
                                    {foreach from=$logentries item=log}
                                        <tr>
                                            <td>{$log.id}</td>
                                            <td>{$log.date|dateformat2:$date_format}</td>
                    ...
                    {if !$forbidAccess.editTransactions  && isset($admindata.access.editTransactions)}
