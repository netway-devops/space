                    ...
                    <table cellspacing="0" cellpadding="6" border="0" width="100%">
                        <tbody class="sectioncontent">
                            ...
                            <tr {if $configuration.EnableProRata == 'off'}style="display:none"{/if} id="prorated_ctrl">
                                ...
                                <td>
                                    <input type="radio" {if $configuration.EnableProRata == 'off'}checked="checked"{/if}
                                           ...
                                           id="prorata_off"/> <label
                                            for="prorata_off"><strong>{$lang.no}</strong></label>
                                    <input type="radio" {if $configuration.EnableProRata == 'on'}checked="checked"{/if}
                                           name="config[EnableProRata]" value="on"
                                           onclick="$('#prorated').ShowNicely();" id="prorata_on"/> <label
                                            for="prorata_on"><strong>{$lang.yes}</strong></label>
                                </td>
                            </tr>
                            <tr id="prorated" {if $configuration.EnableProRata == 'off'}style="display:none"{/if}>
                                ...
                                <td>
                                    {$lang.new_ProRataDay}
                                    <input class="inp" size="2" name="config[ProRataDay]"
                                    ...
                                    <span>
                                        ...
                                        <a class="vtip_description"
                                           title="{$lang.promonthdesc}"></a>
                                        <input type="checkbox" onclick="check_i(this)"
                                               {if $configuration.ProRataNextMonth>0}checked="checked"{/if} value="1"/>
                                        <input type="text" name="config[ProRataNextMonth]"
                                               value="{$configuration.ProRataNextMonth}" class="config_val  inp"
                                               size="3"
                                               {if $configuration.ProRataNextMonth==0}disabled="disabled"{/if}/>
                                    </span>
                                </td>
                            </tr>
                        </tbody>
                                ...
                                <td id="auts-settings" colspan="2">
                                    <table class="editor-container" cellspacing="0" cellpadding="6" width="100%">
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td>
                                                <input type="text" size="3" value="{$configuration.InvoiceGeneration}"
                                                       name="config[InvoiceGeneration]"
                                                       class="inp"/> {$lang.InvoiceGeneration2}
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <div>
                            <table width="100%" cellspacing="0" cellpadding="3" border="0" class="table glike">
                                <tr class="havecontrols">
                                    ...
                                    <td>{$a.description}{if $a.modulename}
