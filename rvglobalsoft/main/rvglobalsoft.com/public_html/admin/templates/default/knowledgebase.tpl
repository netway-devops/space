                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {hbinput id="name" value=$reply.name style="" size="75" name="name" class="form-control"}
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>{$lang.Description}</label><br>
                                            {hbwysiwyg value=$reply.description style="width:100%;" class="wysiw_editor form-control" cols="100" rows="8" id="prod_content" name="description" featureset="full"}
                                    </div>
                                </div>
                            </div>
                            {adminwidget module="knowledgebase" section="forms"}
                            ...
                            <ul>
                                ...
                                <li class="{if $action == 'statistics'} active {/if}">
                                    <a href="?cmd={$cmd}&action=statistics">{$lang.statistics}</a>
                                     <small style="padding-left: 30px;"><a href="?cmd=kbhandle&action=sorter&type=billing&catId=0" class="manageSorter" style="color:green;">เรียงลำดับ</a></small>
                                </li>
                            </ul>
                        </div>
                        <div class="list-2">
...
function kbItemSorter ()
{
    $('.manageSorter').click(function () {
...
function sync(catId){
     kbSyncCatId    = catId;
     $('.nicerblu').addLoader();
     $.post('?cmd=kbongoogle&action=syncKbongoogle&type=cat&id='+ kbSyncCatId,'', function(data){
             parse_response(data);
             $.post('?cmd=kbongoogle&action=syncKbongoogle&type=kb&id='+ kbSyncCatId,'', function(data){
                     parse_response(data);
                     $('#preloader').remove();
             });
     });
