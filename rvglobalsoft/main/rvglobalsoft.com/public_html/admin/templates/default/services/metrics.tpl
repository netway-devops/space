...
{foreach from=$available_metrics key=module_id item=modulem}
    <div style="text-align: left; background: #f1f1f1; border: solid 1px #CCC; border-bottom: none; padding: 10px;"><strong>{$modulem.name} metrics</strong></div>
    <div class="container-fluid" style="border: solid 1px #CCC; padding: 0 10px;">
        <div class="metrics">
