        ...
        <div class="container-fluid sectioncontent">
            ...
            {if $teams}
                ...
                <ul class="staff-list list-group" id="team-assign-list"
                    data-name="teams" data-autoname="teams_auto"
            ...
            <div>
                <ul class="staff-list list-group" id="admin-assign-list"
                    data-name="admins" data-autoname="auto_assignment"
                    data-staff="{$submit.admins|@json_encode|escape}"></ul>
                <p>
                    <strong>Legend:</strong><br/>
                    <i class="fa fa-eye"></i> - Staff or team members can vew and receive notifications for ticket
                    in this department.
                    <br/>
...
<script type="text/javascript">
    $(function () {
        ...
        $('.from-name').on('change', function () {
            ...
            if (!self.is(':checked'))
                return;
            self.nextAll('.form-group').find('input').val('').prop('disabled', val);
        }).trigger('change');
