        ...
        <div class="left recurringinvoice" style="display:none">
            <table border="0" width="300" cellspacing="3" cellpadding="0">
                <tr>
                    ...
                    <td width="200" align="left"><input name="invoice[recurring][start_from]" value="{$invoice.recurring.start_from|dateformat:$date_format}" class="haspicker" id="recurring_start_date" readonly="readonly" /></td>
                </tr>
                <tr>
        ...
        <div class="left">
            <table border="0" cellspacing="3" cellpadding="0">
                <tr>
                    ...
                    <td width="200" align="left" class="standardinvoice"><div ><input name="invoice[date]" value="{$invoice.date|dateformat:$date_format}" class="haspicker" readonly="readonly" /></div></td>
                ...
                <tr>
                    ...
                    <td width="200" align="left" class="standardinvoice"><div ><input name="invoice[duedate]" value="{$invoice.duedate|dateformat:$date_format}" class="haspicker" readonly="readonly" /></div></td>
