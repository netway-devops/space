                    ...
                    <div class="lighterblue" style="padding:5px">
                        ...
                        <table  width="100%" cellspacing="0" cellpadding="6">
                            ...
                            <tr>
                                ...
                                <td><input name="date" size="10" value="{if $annoucement.date}{$annoucement.date|dateformat:$date_format}{else}{$currentdate|dateformat:$date_format}{/if}" class="inp haspicker" readonly="readonly" /></td>
                                </tr>
                             <tr>
	...
	<tr>
		...
		<td>{$ann.date|date_format:'%d %b %Y'}</td>
		<td>{$ann.content}</td>
