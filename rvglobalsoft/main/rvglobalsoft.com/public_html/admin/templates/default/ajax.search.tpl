...
include($templatePath . 'ajax.search.tpl.php');
{/php}
                                ...
                                <div class="panel-body">
                                    <div class="row resultsrow" style="">
                                        ...
                                        <div class="col-md-10 ">
                                            ...
                                            {elseif $r == 'General'}
                                                <a href="{$re.cmdLink}"  target="_blank"><strong>#{$re.id} - {$re.itemName} {$re.clientFirstName} {$re.clientLastName} {if $re.clientCompanyName} - {$re.clientCompanyName} {/if}</strong></a>
                                            {else}
                                        ...
                                        <div class="row metarow">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                {elseif $re.client_id}
                                                    <div class="itm">
                                                    {if $re|@profilelink == '-'}
                                                        <i class="fa fa-user"  data-toggle="tooltip" data-placement="bottom" title="Client"></i> {$re.clientFirstName} {$re.clientLastName} {if $re.clientCompanyName} - {$re.clientCompanyName} {/if}
                                                    {else}
