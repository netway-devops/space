            ...
            <div class="row">
                <div class="col-md-6">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="lookup_engine" name="lookup_engine" class="form-control">
                                    <option value="0" {if !$entry.lookup_engine}selected{/if}> Core</option>
                    ...
                    <div class="panel panel-default" id="panel-lookup">
                        <div class="panel-heading">
                            <strong>Core</strong> Availability check settings
                        </div>
                        <div class="panel-body">
                            <div class="form-group">
                    ...
                    <div class="panel panel-default" id="panel-whois">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group" id="customrequest" {if !$entry.request}style="display:none"{/if} >
                                ...
                                <input type="text" value="{$entry.request|default:$entry.request}" id="request" name="request" class="form-control" />
