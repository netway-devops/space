                    ...
                    <form action="?cmd=sendmessage{if $action != 'default'}&action={$action}{/if}" method="post" id="massform">
                        ...
                        <div class="lighterblue col-sm-12">
                            {if $action != 'asnotification' && $action != 'asmobile'}
                                ...
                                <div class="form-group">
                                    <div>
                                        <input placeholder="E-mail address" type="text" name="from2" value="{if $submit.from2}{$submit.from2}{else}{if $from2}{$from2}{else}{$lang.youremailempty}{/if}{/if}" size="30" class="form-control" />
                                    </div>
                                </div>
                            {/if}
