...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="{$template_dir}hbchat/media/popup.js?v={$hb_version}v"></script>
        ...
        <script type="text/javascript" src="{$template_dir}hbchat/media/soundmanager2-nodebug-jsmin.js?v={$hb_version}v"></script>
