...
//$test_return_func=1;
$url = ($test_return_func) 
		? "http://www.xtreme-webhosting.net/ppipntest/index.php" 
 ...
 */
	...
	$getinv = $db->query("SELECT i.id
		...
		//echo 'xxxx<pre>';print_r($sqlinv);//exit;
	$date = date('Y-m-d H:i:s');

	$getapi = $db->query("SELECT aa.* FROM hb_api_access aa WHERE aa.ip =:iparrow",array(':iparrow'=>$iparrow))->fetch();
