    ...
    <div class="bordered-section article">
        ...
        <div id="bulkdomaintransfer" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="bulkdomaintransferLabel" aria-hidden="true">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="$('#bulkdomaintransfer').modal('hide')">×</button>
                ...
                <td width="50%" align="left">
                    {if $lang.add_domain}
                        <form method="post" action="{$ca_url}checkdomain">
                            <button class="btn btn-info"><i class="icon-shopping-cart icon-white"></i> {$lang.add_domain}</button>
                            {securitytoken}
                        </form>
                    {/if}
                </td>
