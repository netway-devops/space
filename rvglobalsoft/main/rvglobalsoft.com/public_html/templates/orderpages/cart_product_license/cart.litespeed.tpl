    ...
    <div class="span12">
        ...
        <tbody>
            <tr>
                <td>IP Address</td>
                <td>
                    <input type="hidden" id="product" name="product" value="litespeed" />
                    <input type="hidden" id="productId" name="product_id" value="0" />
                    <input type="hidden" name="order_type" value="Register" />
                    <input type="text" id="ipaddress" name="ipaddress" value="" onchange="verifyProductLicense('litespeed', this.value);" placeholder="Require IP Address" />
                </td>
                <td>
