    ...
    <div class="span12">
        ...
        <tbody>
            <tr>
                <td>IP Address</td>
                <td>
                    <input type="hidden" id="product" name="product" value="cloudlinux" />
                    <input type="hidden" id="productId" name="product_id" value="0" />
                    <input type="text" id="ipaddress" name="ipaddress" value="" onchange="verifyProductLicense('cloudlinux', this.value);" placeholder="Require IP Address" />
                </td>
                <td>
