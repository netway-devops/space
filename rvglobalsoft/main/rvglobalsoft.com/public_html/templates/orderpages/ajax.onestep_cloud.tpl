        ...
        <div class="plan-includes">
            <div class="plan-includes-pattern">
                ...
                <div class="total-price">
                    ...
                    <input id="couponcde" type="text" placeholder="Use promotional code">
                    <a href="#" onclick="applyCoupon(); return false">{$lang.Go}</a>
                    {/if}
                    {else}
                ...
                <table>
                    ...
                    {if ($product.hostname) && !($cart_contents[0].domainoptions.register=='1' ||  $allowown || $subdomain)}
                        <tr>
                            ...
                            <td><input name="domain" value="{$item.domain}" class="styled" size="50" onchange="if(typeof simulateCart == 'function') simulateCart();"/>
                            </td>
                        </tr>
