        ...
        {if !$subtotal.coupon}
            ...
            <div class="coupon-field form-horizontal" style="display:none">
                <form onsubmit="applyCoupon(this); return false">
                    <div class="btn-group">
                        <input id="couponcde" class="coupon-input" name="promocode" placeholder="Use promotional code">
            ...
            {/if}
        {else}
        <a href="#" class="promo-code" onclick="removeCoupon(); return false" title="Remove coupon">{$subtotal.coupon} <i class="icon icon-remove icon-white" style="vertical-align: sub"></i></a>
        {/if}
