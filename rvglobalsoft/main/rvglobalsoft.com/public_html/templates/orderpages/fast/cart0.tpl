...
<div class="clear"></div> 
<div class="rvcart">
	<h1>Welcome to Ordering Page</h1>
	<div class="cart-icon">Here you have two options to choose for your purchase of RV2Factor. Either of these options, you have to get VIP certificates first before starting your installation on WHM. You can pay via Paypal and your own credit card. After the payment is completed, you will receive the instructions from an email by our sales staff. </div>
</div>
<div class="clear"></div> 
            ...
            <form name="" action="" method="post">
                ...
                <div>
                    ...
                    {else}
                        ...
                        {if $i.name=='2-factor Authentication'}
                            <select name="cycle" style="display:none;">
                        {else}
                            {$lang.pickcycle}<br />
...
{if $opconfig.footer}
    ...
    {if $products.0.name=='2-factor Authentication'}
    {else}
