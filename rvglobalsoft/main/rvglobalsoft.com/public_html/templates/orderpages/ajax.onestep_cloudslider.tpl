            ...
            {if !$subtotal.coupon}
                ...
                <div class="coupon-field">
                    <form onsubmit="applyCoupon(this); return false">
                        <input id="couponcde" class="coupon-input" name="promocode" placeholder="Use promotional code" onsubmit="applyCoupon(); return false">
                    </form>
                </div>
                {/if}
            {else}
                <a class="btn" href="#" onclick="removeCoupon(); return false" title="Remove coupon">{$subtotal.coupon} <i class="icon icon-remove" style="vertical-align: middle"></i></a>
            {/if}
        </div>
    </div>
</div>
