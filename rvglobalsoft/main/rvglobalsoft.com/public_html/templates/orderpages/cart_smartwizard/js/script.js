$(function(){
    ...
    $('.arrow-box').toggle(function(){
			//$(this).next('.domain-box').css('display','block');
			$(this).parents('.option-box').next('.option-hidden-content').slideDown();
			$(this).prev('a').text('Close');
			$(this).addClass('arrow-up');
		},
		function(){
			//$(this).next('.domain-box').css('display','none');
			$(this).parents('.option-box').next('.option-hidden-content').slideUp();
			$(this).prev('a').text('Open');
