...
<!--[if (gt IE 9)|(gt IEMobile 7)]><!--><html lang="en"><!--<![endif]-->
    <head>
        ...
        <![endif]-->
        <script type="text/javascript" src="{$template_dir}js/jquery-1.8.3.js"></script>
		...
		<link media="all" type="text/css" rel="stylesheet" href="{$template_dir}css/style.css" />
...
<!-- *************** LOGO AND COMPANY NAME *************** -->
			...
			<!-- *************** Start Header Company *******************-->
			{include file='header-company.tpl'}
			<!-- *************** End  Header Company *******************-->
			
			<!-- *************** Start NAavigation Bar *******************-->
			<!--{include file='menus/mainnavigation.tpl'}-->
