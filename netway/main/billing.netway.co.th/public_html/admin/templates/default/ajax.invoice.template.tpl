        ...
        <table border="0" cellpadding="10" width="100%" cellspacing="0" class="sectioncontenttable">
            ...
            <tr class="bordme">
                <td width="205" align="right" valign="top"><strong>{$lang.InvoiceTemplate}</strong>
                    <br/>
                    <a href="?cmd=configuration&action=invoicetemplates&make=createnew&target=invoice&security_token={$security_token}" class="btn btn-success btn-xs">Create new</a>
            ...
            <tr class="bordme">
                <td width="205" align="right" valign="top"><strong>{$lang.EstimateTemplate}</strong><br/>
                    <a href="?cmd=configuration&action=invoicetemplates&make=createnew&target=estimate&security_token={$security_token}" class="btn btn-success btn-xs">Create new</a>
            ...
            {if $configuration.CnoteEnable=='on'}
                <tr class="bordme">
                    <td width="205" align="right" valign="top"><strong>{$lang.CreditNoteTemplate}</strong>
                        <br/>
                        <a href="?cmd=configuration&action=invoicetemplates&make=createnew&target=creditnote&security_token={$security_token}" class="btn btn-success btn-xs">Create new</a>
            ...
            {if $configuration.ReceiptEnable=='on'}
                <tr class="bordme">
                    <td width="205" align="right" valign="top"><strong>{$lang.CreditReceiptTemplate}</strong>
                        <br/>
                        <a href="?cmd=configuration&action=invoicetemplates&make=createnew&target=creditreceipt&security_token={$security_token}" class="btn btn-success btn-xs">Create new</a>
            ...
            <tr class="bordme">
                <td width="205" align="right" valign="top"><strong>Attachment templates</strong>
                    <br/>
                    <a href="?cmd=configuration&action=invoicetemplates&make=createnew&target=attachment&security_token={$security_token}" class="btn btn-success btn-xs">Create new</a>
