                ...
                {elseif $action=='group'}
                    ...
                    <div>
                        <div class="imp_msg">
                            ...
                            - การเปลี่ยน default server ไม่มีผลต่อรายการ <a href="?cmd=services" target="_blank">Product and Service</a> ต้องไปตั้งค่าใหม่ที่นั่น (อย่าง sharehost เจ้าหน้าที่คิดว่าตั้ง default แล้ว Product Service จะปรับตาม) <br />
                        </div>
                    </div>
