                    ...
                    {if !$ticket.share || $ticket.share=='master'}
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <input name="email" value="{$ticket.email}" style="display: none; width: 250px" autocomplete="off" class="inp"/>
                            </td>
                        </tr>
                    {else}
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <input name="email" value="{$ticket.email}" autocomplete="off" style="display: none; width: 250px" class="inp"/>
                            </td>
                        </tr>
                    {/if}
