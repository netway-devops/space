    ...
    {if $server_fields &&  $server.type!='Domain'}
        ...
        {else}
              ...
              <div class="imp_msg">
                  ...
                  - ไม่ต้องเอา server เก่าออก เพิ่ม server ใหม่พอ เพราะถ้า service มาหาว่า product นี้แล้วไม่พบการเชื่อมต่อกับ server ที่ตัวเองใช้อยู่จะทำ provisioning ไม่ได้<br />
              </div>
