...
<form action="" method="post" id="invoiceeditform" style="padding: 10px 0">
    ...
    <div>
        <br />
        <span> <label class="label label-danger">Template</label> ต้องนำมาจากไฟล์ Repository : documents/invoice_template.tpl แก้ไขและ commit ให้เป็น version ล่าสุด </span>
        <br /><br />
    </div>
