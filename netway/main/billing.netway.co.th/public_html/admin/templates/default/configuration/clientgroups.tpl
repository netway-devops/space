    ...
    <form action="" method="post" id="sme">
        ...
        <div style="padding:15px;">
            ...
            <div class="sectioncontent" style="display:none">
                ...
                <div class="form-group">
                    ...
                    <div class="toggle-override">
                        ...
                        <div class="contener">
                            ...
                            <div class="option-line">
                                <input name="settings[FinalInvoiceOnPayment]" type="radio" value="never"
                                       {if $configuration.FinalInvoiceOnPayment=='never'}checked{/if}
                                       class="inp"/>
                                <strong>Never, </strong>do not generate final invoice numbers
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <strong>{$lang.MergeInvoiceOptions}</strong>
                    <div class="toggle-override">
                        <input type="checkbox" name="settings_enabled[MergeDomainRenewals]" class="toc" value="1"
                               {if $groupx.settings_enabled.MergeDomainRenewals}checked{/if} />
                        Override invoice merge settings
                        <div class="contener">
                            <div class="option-line">
                ...
                <div class="form-group">
                    <strong>Credit on Downgrade</strong>
                    <div class="toggle-override">
                        <input type="checkbox" name="settings_enabled[CreditOnDowngradeOverride]" class="toc" value="1"
                               {if $groupx.settings_enabled.CreditOnDowngradeOverride}checked{/if} />
                        Override billing settings

                        <div class="contener">
                            <select name="settings[CreditOnDowngradeOverride]">
                ...
                <div class="form-group">
                    ...
                    <div class="toggle-override">
                        ...
                        Override billing settings
                        <div class="contener">
                            <select name="{$settings[$attach_type].name}" data-toggle>
                                {foreach from=$settings[$attach_type].items item=item}
                            ...
                            <div class="opt_AddToPrintQueue" style="padding-left: 10px; margin: 10px 5px; border-left: 1px solid #ddd; {if
                                ...
                                {if  $configuration.InvoiceModel=='eu'}
                                    ...
                                    <div class="option-line">
                                        <input type="radio" name="settings[AddToPrintQueue]" value="proforma"
                                               {if $configuration.AddToPrintQueue=='proforma'}checked{/if}/>
                                        {$lang.ProForma}
                                    </div>
                                    <div class="option-line">
                                        <input type="radio" name="settings[AddToPrintQueue]" value="final"
                                               {if $configuration.AddToPrintQueue=='final'}checked{/if}/>
                                        {$lang.FinalInvoice}
                                    </div>
                                {/if}
                            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="toggle-override">
                        <input type="checkbox" name="settings_enabled[CollectionInvoicesOnDays]" class="toc" value="1"
                               {if $groupx.settings_enabled.CollectionInvoicesOnDays}checked{/if} />
                        Override billing settings
                ...
                <div class="form-group">
                    <strong>{$lang.InvoiceTemplate}</strong>
                    <div class="toggle-override">
                        <input type="checkbox" name="settings_enabled[InvoiceTemplate]" class="toc" value="1"
                               {if $groupx.settings_enabled.InvoiceTemplate}checked{/if} />
                        Override billing settings
                ...
                <div class="form-group">
                    <strong>{$lang.EstimateTemplate}</strong>
                    <div class="toggle-override">
                        <input type="checkbox" name="settings_enabled[EstimateTemplate]" class="toc" value="1"
                               {if $groupx.settings_enabled.EstimateTemplate}checked{/if} />
                        Override billing settings
                ...
                {if $configuration.CnoteEnable == 'on'}
                    <div class="form-group">
                        <strong>{$lang.CreditNoteTemplate}</strong>
                        <div class="toggle-override">
                            <input type="checkbox" name="settings_enabled[CNoteTemplate]" class="toc" value="1"
                                   {if $groupx.settings_enabled.CNoteTemplate}checked{/if} />
                            Override billing settings
                ...
                {if $configuration.ReceiptEnable == 'on'}
                    <div class="form-group">
                        <strong>{$lang.CreditReceiptTemplate}</strong>
                        <div class="toggle-override">
                            <input type="checkbox" name="settings_enabled[ReceiptTemplate]" class="toc" value="1"
                                   {if $groupx.settings_enabled.ReceiptTemplate}checked{/if} />
                            Override billing settings
            ...
            <div class="sectioncontent" style="display:none">
                {if $action == 'overrides'}
                    <div class="form-group">
                        ...
                        <div class="toggle-override">
                            <input type="checkbox" name="settings_enabled[DefaultTimezone]" class="toc" value="1"
                                   {if $groupx.settings_enabled.DefaultTimezone}checked{/if} />
                            Override system settings

                            <div class="contener">
                                <div class="option-line">
                                    <select name="settings[DefaultTimezone]" class="form-control "  >
                        ...
                        <div class="toggle-override">
                            ...
                            <div class="contener">
                                ...
                                <input type="radio" value="1" name="settings[EnableAutoCreations]"
                                       ...
                                       data-toggle="#autosetup_opt" onclick="$('#autoon_').click();"/>
                                <label for="autoon"><b>{$lang.yes}</b></label>

                                    <div class="p5" style="color:red">สำหรับ Domain ถ้าเลือก auto register เป็น No ระบบจะไม่ Accept Order ให้อัตโนมัติ (แม้จะ Add payment แล้วก็ตาม)</div>
                        ...
                        <div class="toggle-override">
                            ...
                            <div class="contener">
                                <input type="radio"
                                       ...
                                       name="EnableAutoUpgrades" value="off"
                                       data-toggle="" onclick="$('#auto_up_off').click();"
                                       id="upgrades_off" />
                                <label for="upgrades_off"><b>{$lang.no}</b></label>

                                <input type="radio"
                                       {if $configuration.EnableAutoUpgrades !== 'off'}checked="checked"{/if}
                                       name="EnableAutoUpgrades" value="on"
                                       data-toggle="#upgrades_options" onclick="$('#auto_up_pay').click();"
                                       id="upgrades_on"/>
                                ...
                                <div class="p5" id="upgrades_options" style="{if $configuration.EnableAutoUpgrades == 'off'}display:none;{/if}margin-top:10px;border:#ccc 1px solid;">
                                    ...
                                    <input type="radio" {if $configuration.EnableAutoUpgrades === 'on'}checked{/if}
                                           name="settings[EnableAutoUpgrades]"  id="auto_up_pay" value="on"/>
                        ...
                        <div class="toggle-override">
                            ...
                            <div class="contener">
                                <input type="radio"
                                       ...
                                       data-toggle=""
                                       id="renew_off_dom"/><label for="renew_off_dom"><b>{$lang.no}</b></label>
                                ...
                                <input type="radio"
                                       ...
                                       id="renew_on_dom"/><label for="renew_on_dom"><b>{$lang.yes}</b></label>

                                    <div class="p5" style="color:red">สำหรับ Domain ต้องเลือก Auto renew เป็น Yes มิเช่นนั้นระบบจะไม่ Gen renew order ให้</div>
                            ...
                            <div class="contener">
                                ...
                                <div class="p5" id="reminder_options"
                                    ...
                                    {$lang.InvoiceUnpaidReminder} <span>
                                        ...
                                        <input type="text" size="3"
                                               class="config_val  inp" {if $configuration.InvoiceUnpaidReminder<=0} value="0" disabled="disabled"{else}value="{$configuration.InvoiceUnpaidReminder|escape}"{/if}
                        ...
                        <div class="toggle-override">
                            ...
                            <div class="contener">
                                <div class="p5" id="latefeedays_options"
                                    ...
                                    <input type="text" size="3" value="{$configuration.AddLateFeeAfter|escape}"
            ...
            <div class="sectioncontent" style="display:none">
                        ...
                        <div class="contener">
                            ...
                            <div>
                                ...
                                <input type="text" name="settings[ProRataNextMonth]"
                                       value="{$configuration.ProRataNextMonth|escape}" class="inp" size="3" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="toggle-override">
                        <input type="checkbox" name="settings_enabled[ContractGeneration]" class="toc" value="1" {if $groupx.settings_enabled.ContractGeneration}checked{/if} />
                        Override system / package settings

                        <div class="contener">
                            <div class="option-line">
                                <input name="settings[ContractGeneration]" type="radio" value="generate" {if $configuration.ContractGeneration=='generate'}checked{/if} class="inp"/>
                                {$lang.GenerateContractForEachNewClient} <br>
                            </div>
                            <div class="option-line">
                                <input name="settings[ContractGeneration]" type="radio" value="default" {if $configuration.ContractGeneration=='default'}checked{/if} class="inp"/>
                ...
                <div class="form-group">
                    <label>{$lang.DefaultPaymentModule|default:"Default payment gateway"}</label>
                    <div class="toggle-override">
                        <input type="checkbox" name="settings_enabled[DefaultPaymentModule]" class="toc" value="1" {if $groupx.settings_enabled.DefaultPaymentModule}checked{/if} />
                        Override system  settings

                        <div class="contener">
                            <select name="settings[DefaultPaymentModule]" class="form-control overridedefault" data-default="0">
                                <option value="0">None</option>
                                {foreach from=$gateways item=gateway key=modid}
                                    <option value="{$modid}"
                                            {if $groupx.settings.DefaultPaymentModule==$modid}selected{/if}>
                                        {$gateway}
                                    </option>
                                {/foreach}
                            </select>
            ...
            <div class="sectioncontent" style="display:none">
                ...
                <div class="form-group">
                    <label>{$lang.DefaultTicketRate}</label>
                    <select name="settings[DefaultTicketRate]" class="form-control overridedefault" data-default="">
                        <option value="">
                            Default
                        </option>
                        {foreach from=$supportrates item=rate}
                            <option value="{$rate.id}" {if $configuration.DefaultTicketRate == $rate.id}selected{/if}>{$rate.name}</option>
                        {/foreach}
                    </select>
                </div>

                <div class="form-group">
                    <label>Explicit ticket departments access</label>
                    <a class="vtip_description" title="Departments with explicit access to which client has access"></a>
                    <br>
                    {foreach from=$support_departments item=dept}
                        <span style="margin-right: 20px;">
                            <input name="settings[SupportDepartments][]" {if in_array($dept.id, $configuration.SupportDepartments)} checked="checked" {/if} type="checkbox" value="{$dept.id}">
                            {$dept.name}
                        </span>
                    {/foreach}
                </div>
