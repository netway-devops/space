    ...
    {if $product}
        ...
        {if $product.hostname || $product.owndomain || $product.domain_options}
            <div class="like-table-row">
                ...
                <div>
{* code เดิมมีการพยายามใส่domain ให้กับ host *}
                    {if $draft.domains}
        ...
        <div class="like-table-row">
            <div style="width:160px;padding-top: 12px;">
                {if !$submit.service}
                    QTY: <input type="text" size="3" value="1" placeholder="1" name="qty" disabled/>
                {/if}
            </div>
...
{* code เดิมมีการทำ puny code ให้ domain idn *}
            ...
            <form action="" method="post">
                ...
                <table  width="100%" cellspacing="2" cellpadding="3" border="0" style="table-layout: fixed;">
                    ...
                    <tr>
                        ...
                        <td >
                                <span class="editbtn_flash">
                                    <a href="?cmd=managemodules&action=payment{if $draft.module==0}&expand=true&id=4{else}&expand=true&id={$draft.module}{/if}" target="_blank" >
                                        {if $draft.module}
                                            {if $modules}
