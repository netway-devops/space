...
include($templatePath . '/_common/orders_address_notification.tpl.php');
{/php}
...
<div style="display: block;">
    ...
    <div class="ticketmsg ticketmain" style="width: 350px; display: block; float: left;">
        ...
        <div style="background-color: #FFFFFF; padding: 5px;">
            ...
            <br />
            <div align="right"><a href="?cmd=addresshandle&action=listInvoice&type=billing&orderDraftId={$draft.id}" class="manageContactAddress">แก้ไข</a></div>
        </div>
    </div>
