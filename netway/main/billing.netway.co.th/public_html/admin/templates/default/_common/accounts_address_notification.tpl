    ...
    <div style="display: block;">
        ...
        {if isset($isPendingUpgrade)}
        <div class="bordered ticketmsg ticketmain" style="width: 300px; display: block; float: left; margin-left: 10px;">
            <div><b>Account นี้มีรายการส่งซื้อแบบ upgrade:</b></div>
            <div style="background-color: #FFFFFF; padding: 5px;">
                {$upgradeMessage}
            </div>
        </div>
        ...
        <div class="ticketmsg ticketmain" style="display: block; width:99%;">
            ...
            <thead style="text-align: left;">
                <tr class="blu">
                    ...
                    <th>Phone</th>
                    <th align="center" width="100"> <!-- {if isset($admindata.access.editAccounts)} <a href="?cmd=addresshandle&action=listNotify&type=account&serviceId={$details.id}" class="manageContactAddress">Add</a> {/if} --> </th>
                    <th>Note</th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="100" align="center" nowrap="nowrap">
                        ...
                        <!-- <a href="?cmd=addresshandle&action=removeNotify&type=account&serviceId={$details.id}&clientId={$aNotifiyPerson.id}" class="removeContactAddress editbtn">Remove</a> -->
                        {/if}
                    </td>
                    <td width="500">
                        {if isset($admindata.access.editAccounts)}
