                        ...
                        <td style="padding:8px 5px 9px;">
                            {if $VMDetails.powerState=='poweredOn' || $VMDetails.powerState=='poweredOff'}
                                {if $VMDetails.powerState=='poweredOn'}
                                    <a class="state_switch on"
                                       href="?cmd=clientarea&action=services&service={$service.id}&vpsdo=poweroff&vpsid={$VMDetails.uuid}&security_token={$security_token}"
                                ...
                                {else}
                                    ...
                                    <a class="state_switch off"
                                       href="?cmd=clientarea&action=services&service={$service.id}&vpsdo=poweron&vpsid={$VMDetails.uuid}&security_token={$security_token}"
                            ...
                            {else}
                                 ...
                                 <a class="state_switch off">{$lang.Off}</a>
