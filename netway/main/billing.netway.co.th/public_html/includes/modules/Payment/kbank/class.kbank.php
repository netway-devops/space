...
class kbank extends PaymentModule {
    ...
    public function drawForm() {
        ...
        $string = "<form action='https://rt05.kasikornbank.com/pgpayment/payment.aspx' name='paykbank' method='POST'>";
		 ...
		 //$string.="<input type='hidden' name='RESPURL' value='https://netway.co.th/kkpayment/mod_kbankritikg0Hf.php'/>";
	...
	function callback() 
	{
        ...
        //3.sendmail
        $subject = 'Netway Kbank:: Order '. date('Y-m-d H:i:s') ;
        $headers = 'From: admin@netway.co.th' . "\r\n" .
        'Reply-To: admin@netway.co.th' . "\r\n" .
        'X-Mailer: PHP/' . phpversion();

        $message = "KASIKORN BANK :: Summary Order ". date('Y-m-d H:i:s') ."\n";
        $message .= "--------------------------------------------\n";
		...
		if($isVerify) {
            ...
            @mail('siripen@netway.co.th,monthira@netway.co.th', $subject, $message, $headers);
