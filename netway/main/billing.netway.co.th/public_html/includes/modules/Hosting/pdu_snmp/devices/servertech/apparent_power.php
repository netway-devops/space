...
$active_power = $snmp->Get('.1.3.6.1.4.1.1718.3.2.3.1.15.'.$port);
if(!$active_power) {
    throw new Exception("Unable to fetch  port's apparent power PDU");
}


$apparent_power = str_ireplace('INTEGER: ','',$active_power);
