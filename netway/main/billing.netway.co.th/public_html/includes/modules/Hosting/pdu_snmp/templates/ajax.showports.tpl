{if $ports}
    <div class="row">
        <div class="col-md-7">
            <select name="pdu_port_id" id="pdu_port_id" class="form-control">
        ...
        <div class="col-md-2">
            ...
            <a href="#" onclick="return assignPort();" class="btn btn-success" onclick="return false;"><span class="addsth"><strong>Assign</strong></span></a>
        </div>
    </div>
