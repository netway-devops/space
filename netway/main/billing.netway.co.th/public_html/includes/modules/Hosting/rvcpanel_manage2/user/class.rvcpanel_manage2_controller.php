    ...
    public function changeip($params)
    {
        ...
        if ( $aChkValidate['res']  == true) {
            ...
            if($lisc instanceof SimpleXMLElement && $lisc->attributes()->status  == 1) {
                ...
                if ($resUpdateIp == false)  $txt .= ' Errro : update ip ใน custom ';
                ...
                if ($resLog == false)  $txt .= ' Errro : update log ';
                $resInsertLogIp = RVProductLicenseDao::singleton()->InsertLogTransferIp(array(                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
                 ...
                 if ($resInsertLogIp == false)  $txt .= ' Errro : update Transfer limit log ';
                $aRes['msg'] = 'success:'.$txt;   
            } else {
                $aRes['res'] = false;
                $aRes['msg'] = ' API error connecting to cPanel Manage2.';
            }               
