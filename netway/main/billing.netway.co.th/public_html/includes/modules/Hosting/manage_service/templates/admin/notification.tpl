...
<div id="box-ping-sms" style="display:none">
    <div class="box">
        <div class="box-header well">
            <h2>Server Up/Down SMS to staff</h2>
        </div>
        <div class="box-content">
            <div class="box-content">
                <ul class="dashboard-list">
                    <li>
                        <div style="float:left;">
                            <input type="checkbox" attrKey="action-key-ping-sms" attrPeriod="manage-service-action-ping-sms-esc-period" 
                                class="manage-service-switch-actions" id="manage-service-switch-action-ping-sms" checked /> 
                        </div>
                        <div style="float:left;">
                             ถ้า down email จะแจ้งทันทีและแจ้งซ้ำทุกๆ 
                            <input  type="text" attrKey="action-key-ping-sms" 
                                attrSwitch="manage-service-switch-action-ping-sms" 
                                class="manage-service-actions-esc-period" 
                                name="manage-service-action-ping-sms-esc-period" 
                                id="manage-service-action-ping-sms-esc-period" 
                                value="600" size="6" maxlength="6" style="text-align: right;">
                            seconds จนกว่าเครื่องจะ up
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div style="float:left;">
                            ...
                            <input  type="text" attrKey="action-cpu-processor-load-high" attrSwitch="manage-service-switch-cpu-processor-load"
                             ...
                             id="manage-service-action-cpu-processor-load-esc-period" value="600" size="6" maxlength="6" style="text-align: right;"> 
                    ...
                    <li>
                        ...
                        <div style="float:left;">
                            ...
                            <input  type="text" attrKey="action-memory-lack-free-swap" attrSwitch="manage-service-switch-memory-lack-free-swap" 
                              ...
                              id="manage-service-action-memory-lack-free-swap-esc-period" value="600" size="6" maxlength="6" style="text-align: right;"> 
                            seconds จนกว่าเครื่องจะเป็นปกติ
                        </div>
