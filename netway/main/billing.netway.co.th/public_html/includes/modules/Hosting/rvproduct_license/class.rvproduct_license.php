...
class rvproduct_license extends HostingModule
{
    ...
    public $conn;
    public $server_username = 'rvglobal_rvstore';
    public $server_password = '(b{=?t&%E)Gi';
    public $server_hostname = 'rvglobal_main';
    public $server_ip = '75.126.165.114';
    
	public $aDBSK = array(
		'user' => 'rvskin_rvglobal',
		'pwd' => 'q&m%2K5Rvtm%',
		'dbname' => 'rvskin_tempo',
		'host' => '75.126.165.114'
	);
