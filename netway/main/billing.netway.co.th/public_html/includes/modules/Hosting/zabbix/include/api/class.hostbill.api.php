...
class HostbillApi {
     ...
     * Enter description here ...
     * @param $switchID
     * @example HostbillApi::singleton()->getRackItemIdBySwitchId(203.78.96.249)
     */
    public function getRackItemIdBySwitchId($switchID="") {
        
        return HostbillDao::singleton()->findRackItemIdBySwitchId($switchID);
    ...
    public function execCurl($curlOptionUrl=null) {
	    ...
	    if ($csrfToken == '') {
	        throw new Exception('Not found X-CSRF-Token. Please check script require login user,password admin');
	    }
	    ...
	    curl_setopt($ch, CURLOPT_URL, $url . $curlOptionUrl);
