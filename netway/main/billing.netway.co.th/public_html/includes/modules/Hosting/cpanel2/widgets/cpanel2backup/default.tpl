                                ...
                                <tfoot>
                                    <tr {counter}{if $even % 2 !=0}class="even"{/if}>
                                        <td colspan="4">{$lang.yourbackapslocatedin} 
                                            <strong>{if $ftp_homedir}{$ftp_homedir}{else}home/yourusername{/if}</strong> {$lang.cpanel_directory}
                                        </td>
                                    </tr>
                                    <tr {counter}{if $even % 2 !=0}class="even"{/if}>
                                        <td style="border:none" colspan="4">
                                            <input class="btn" type="submit" name="save" value="{$lang.cpanel_create_backup}">
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
