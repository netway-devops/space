...
/*
 * INSERT INTO  `managene_hostbill`.`hb_admin_fields` (
`id` ,
`name` ,
`variable` ,
`type` ,
...
VALUES (
NULL ,  'Two-Factor Authentication',  '2faenable',  'check',  '{$lang.enable}'
), (
...
class google2factorforadmins extends OtherModule implements Observer {
    ...
    protected $description  = '***NETWAY*** ระบบ 2factor สำหรับ admins';
    ...
    public function before_displayadminheader()
    {
        ...
        if (isset($aAdmin['email']) && $aAdmin['email'] == 'admin@netway.co.th') {
            return true;
        }
        ...
        $bn = $this->adminName . '@netway.co.th';
