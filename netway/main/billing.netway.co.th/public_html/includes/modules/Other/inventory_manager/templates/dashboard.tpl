        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="usr">Enter item serial number:</label>
                    <input type="text" class="form-control" name="sn" id="itemsearch" onkeyup="return searchItems(this, event);">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="usr">Enter item name:</label>
                    <input type="text" class="form-control" name="name" id="itemsearchname" onkeyup="return searchItems(this, event);">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="usr">Enter item vendor:</label>
                    <input type="text" class="form-control" name="vendor" id="itemsearchvendor" onkeyup="return searchItems(this, event);">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="usr">Enter item manufacturer:</label>
                    <input type="text" class="form-control" name="manufacturer" id="itemsearchmanufacturer" onkeyup="return searchItems(this, event);">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="usr">Enter item status:</label>
                    <input type="text" class="form-control" name="status" id="itemsearchstatus" onkeyup="return searchItems(this, event);">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="usr">Enter item location:</label>
                    <input type="text" class="form-control" name="location" id="itemsearchlocation" onkeyup="return searchItems(this, event);">
                </div>
            </div>
        </div>
            ...
            function searchItems(that, event){
                var search = function(){
                    if($.active){
                        ...
                        Search.Timeout = setTimeout(search,500);
                        return false;
                    }
                    var input = $(that),
                        grid = input.parents('.content').find('table');

                    if(Search.requestString != input.val() || event.keyCode == 13){
                        Search.requestString = input.val();
