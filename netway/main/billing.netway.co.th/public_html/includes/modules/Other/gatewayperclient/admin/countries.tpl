        ...
        {foreach from=$configs item=config name=fff}
            <tr>
                ...
                <td style="white-space: nowrap;">
                    <a href="?cmd={$modulename}&action=removeconfig&id={$config.id}&security_token={$security_token}&page=countries" onclick="return confirm('Are you sure you want to remove this config?')" style="color: red">Remove</a>
                </td>
            </tr>
            {foreachelse}
            <tr>
...
{elseif $action == 'addcountries'}
    <div style="padding:15px;">
        <form action="?cmd=gatewayperclient&action=addcountries" method="POST">
            <table id="tableform" cellpadding="5" style="width: 100%">
                ...
                <tr>
                    <td>
                        ...
                        <p class="small-descr">
                            Select payment gateways that will be available for these countries
                        </p>
                    </td>
                    <td>
