...
<div class="mmfeatured-inner">
        ...
        <li style="border:none;">
            <div>
                ...
                $(document).ready(function () {
                    ...
                    CKFinder.setupCKEditor( CKEDITOR.instances.detailHelpdesk );
                });
                {/literal}
                </script>
            </div>
    ...
    <h3>วิธีแก้ปัญหาทีม SYSNOC หรือ ITS</h3>
        ...
        <li style="border:none;">
            <div>
                ...
                $(document).ready(function () {
                    ...
                    CKFinder.setupCKEditor( CKEDITOR.instances.detailSupport );
                });
                {/literal}
                </script>
            </div>
