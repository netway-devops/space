...
<div class="mmfeatured-inner">
        ...
        <tr>
            ...
            <td>
            &nbsp;&nbsp;&nbsp;
            <a href="?cmd=zendeskintegratehandle&action=syncServiceRequest&exit=1" target="_blank" onclick="return confirm(' Confirm - ใช้เวลานานประมาณ 2-3 นาที ? ');" style="color:red;" ><strong>Sync</strong></a>
            &nbsp;&nbsp;&nbsp;
