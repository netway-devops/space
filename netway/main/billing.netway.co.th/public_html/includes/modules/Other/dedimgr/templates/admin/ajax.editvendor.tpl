<div id="formcontainer">
    <div id="formloader" style="background:#fff;padding:10px;"> <form action="?cmd=dedimgr&do=vendors&vendor_id={$vendor.id}&make=editvendor" method="post" id="addcolocation">
