<div id="formcontainer">
    <div id="formloader" style="background:#fff;padding:10px;"> <form action="?cmd=dedimgr&do=flooredit&floor_id={$floor.id}" method="post" id="addcolocation">

            <div class="tabb colo_floor">
                <h3 style="margin:0px;">Edit colocation floor</h3>
    ...
    <div class="dark_shelf dbottom">
        ...
        <div class="right">
            <span id="savechanges" >
                <span class="bcontainer " ><a class="new_control greenbtn" href="#" onclick="$('#addcolocation').submit(); return false"><span><b>Save floor</b></span></a></span>
                <span >{$lang.Or}</span>
            </span>
