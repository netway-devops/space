<div id="formcontainer">
    <div id="formloader" style="background:#fff;padding:10px;"> <form action="?cmd=dedimgr&do=inventory&subdo=category&make=editcategory&id={$category.id}" method="post" id="addcolocation">
