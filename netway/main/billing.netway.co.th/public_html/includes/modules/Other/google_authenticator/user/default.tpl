                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="left" colspan="2" style="padding-bottom:10px;">
                            ...
                            <input name="securitycode" value="" class="styled form-control" type="number" style="width:98%" autofocus/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-actions">
                                ...
                                {/if}
                                <div class="right">
                                    <button type="submit" value="" class="btn btn-info btn-large" style="font-weight:bold">
