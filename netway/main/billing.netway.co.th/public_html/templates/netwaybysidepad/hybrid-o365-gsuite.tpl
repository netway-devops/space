...
@media (min-width: 1200px){
    ...
    .hybrid365{ 
            ...
            background-image: linear-gradient(to right, #dd4215 , #eb6724);
    }
    .btn-hybrid{
        background: #3a4bff;
        color: #ffffff;
...
$(document).ready(function() {
    ...
    function toggleActiveClass(el){
       ...
       $(window).scroll(function(e){
        ...
        var pos2 = $('#customTab').position();
         if($(window).scrollTop() >= pos2.top){
            $('.dynamic-menu').addClass('fix-top-dynamic-menu');
        }else{
            $('.dynamic-menu').removeClass("fix-top-dynamic-menu");
        }
    ...
    var gsuiteMenu = $(".gsuite-menu");
    var o365Menu = $(".o365-menu");
    
    $('#hybrid-gsuite-logo').on('click', function(){
        $('#hybrid-o365-logo').removeClass('active');
        $('#hybrid-gsuite-logo').addClass('active');
        $('#hybrid-o365').addClass('hidden');
        $('#hybrid-gsuite').removeClass('hidden');
        gsuiteMenu.each(function() {
             $( this ).removeClass('hidden');
        });
        o365Menu.each(function() {
             $( this ).addClass('hidden');
        });
    });
    
    $('#hybrid-o365-logo').on('click', function(){
        
        $('#hybrid-gsuite-logo').removeClass('active');
        $('#hybrid-o365-logo').addClass('active');
        $('#hybrid-o365').removeClass('hidden');
        $('#hybrid-gsuite').addClass('hidden');
     ...
     $('#hybrid-gsuite-logo-phone').on('click', function(){
        $('#hybrid-o365-logo-phone').removeClass('active');
        $('#hybrid-gsuite-logo-phone').addClass('active');
        $('#hybrid-o365').addClass('hidden');
        $('#hybrid-gsuite').removeClass('hidden');
    });
    $('#hybrid-o365-logo-phone').on('click', function(){
        
        $('#hybrid-gsuite-logo-phone').removeClass('active');
        $('#hybrid-o365-logo-phone').addClass('active');
        $('#hybrid-gsuite').addClass('hidden');
        $('#hybrid-o365').removeClass('hidden');
    });
...
{/literal}
              ...
              <div class="container">       
                <div class="span7 hero-inner hidden-phone" >
                    <div style="margin-top: 70px;text-align: left;font-family: 'Prompt', sans-serif;margin-left: 45px;">                     
                       <h2 class="re-txt-banner" style="font-size: 36px;line-height: 49px;text-align: center;"><b>Solution Hybrid Email Microsoft 365</b></h2>
                       <h2 class="re-txt-banner" style="font-size: 32px;letter-spacing: 1px;text-align: center;"><b style="letter-spacing: 1px;">ลดต้นทุนอีเมล มากกว่า 28%</b></h2>
                        <center>
                ...
                <div class="span5 hero-inner hidden-phone" style="width: 42%;margin:0px 0px 0px -16px;">
                     <img class="lazy-hero " data-src="https://netway.co.th/templates/netwaybysidepad/images/hybrid-banner.png" alt="" border="0" width="100%" style="margin-top: 20px;">
                </div>  
                <div class="span6 hero-inner visible-phone">
                <div style="text-align: center;font-family: 'Prompt', sans-serif;padding: 9px 8px;">                     
                    <h2 class="re-txt-banner" style="font-size: 30px;line-height: 38px;letter-spacing: 2px;"><b>Solution Hybrid Email Microsoft 365</b></h2>
                    <h2 class="re-txt-banner" style="font-size: 25px;letter-spacing: 1px;"><b style="letter-spacing: 1px;">ลดต้นทุนอีเมล มากกว่า 28%</b></h2>
    ...
    <section id="customTab" style="margin-top: 0px;   background-color: #4489FF;">
        <div class="dynamic-menu hidden-phone  container " style="background-color: #4489FF; width: 100%;">
            <div  class="container">
                <ul id = 'o365Menu' class="dynamic-nav ">
                    ...
                    <li class="dynamic-nav gsuite-menu hidden"><a class="dynamic-nav nav-Features active" href="#FeatureGsuite">Feature </a></li>
                    <li class="dynamic-nav gsuite-menu hidden" ><a class="dynamic-nav nav-PlanandPricing" href="#PlanandPricingGsuite">Plan and  Pricing</a></li>
                    <li class="dynamic-nav gsuite-menu hidden"><a class="dynamic-nav nav-faq" href="#faq">FAQ</a></li>
    ...
    <div class="row-fluid"  style="margin-top: 20px;">
      <div class="container">
           <div class="span12" style="float: left;" class="hidden-phone">
               
            <ul class=" hidden-phone  hybrid-tap" style="0px solid #fff;">
                <span id="hybrid-o365-logo" class="active"><li    style="color: #ffffff;background: #E3511C;border: 2px solid #9d2600;margin: 0px 2px 0px 1px;width: 310px;">
                 <img src="https://netway.co.th/templates/netwaybysidepad/images/hybrid-o365-logo.png" alt="Microsoft 365" style="width: 52px;margin-left: -28px;">
                 &nbsp;&nbsp;<span style="text-align: center;font-size: 18px;">Hybrid Email Microsoft 365</span>
                </li> </span>
              <span id="hybrid-gsuite-logo" class=""><li  style="color: #ffffff;background: #3297E2;border: 2px solid #00479f;">
                   <img  src="https://netway.co.th/templates/netwaybysidepad/images/hybrid-gsuite-logo.png" alt="G Suite" style="width: 46px;margin-left: -44px;">
                  &nbsp;&nbsp;<span style="text-align: center;font-size: 19px;">Hybrid Email G Suite </span>
              </li></span>
            </ul>
        </div>
         <div class=" visible-phone" style="float: left;">
             <ul class="hybrid-tap " style="margin: 0px 0px 0px 3px;padding: 0;box-sizing: border-box;">
              <span id="hybrid-o365-logo-phone" class="active" >
                  <li  style="color: #ffffff;background: #E3511C;border: 2px solid #9d2600;">
                  <img src="https://netway.co.th/templates/netwaybysidepad/images/hybrid-o365-logo.png" alt="Microsoft 365" style="width:48px; margin-right: 0px;">
                  <span style="text-align: center;font-size: 16px;">Hybrid Email Microsoft 365 </span>
                </li>
              </span>
              <span id="hybrid-gsuite-logo-phone" class="">
                 <li  style="color: #ffffff;background: #3297E2;border: 2px solid #00479f;">
                  <img  src="https://netway.co.th/templates/netwaybysidepad/images/hybrid-gsuite-logo.png" alt="G Suite" style="width: 41px;margin-left: -21px;">
                  <span style="text-align: center;font-size: 16px;margin-left: 9px;">Hybrid Email <br> G Suite </span>
                </li>
              </span>
             </ul>
        </div>
...
<div class="row-fluid" id='hybrid-o365'> 
        ...
        <div class="container">
            <div class="row " >       
               <div class="span11 dynamic-content" >
                   ...
                   โซลูชันของ Hybrid Email Microsoft 365 นั้นคือการเลือกผสมการใช้งานร่วมกันระหว่าง User บน Microsoft 365 และบน Email Server ประเภทอื่น เช่น Email Server บน Control Panel ทั่วไป บนเครื่องประเภท Shared Hosting หรือ Virtual Private Server (VPS) หรือ Dedicated Server ก็ได้ภายใต้โดเมนเนมเดียวกัน 
                   <br> <br> ตัวอย่างเช่น ถ้าองค์กรของคุณมีพนักงาน 100 คน และมีงบประมาณที่จัดสรรให้แก่ Microsoft 365 User เพียง 30 คน คุณสามารถเลือกวางอีก 70 Users นั้นไว้บน VPS เครื่องอื่นได้
                   </p>
            ...
            <div class="row " style="margin-top: 30px;"> 
                <center>
                <table class="hybrid-365-price hidden-phone " style="font-size: 17px;table-layout: fixed;width: 83%;font-family: 'Prompt', sans-serif;">
                  <tbody>
                    <tr>
                        <th style="border: none;"> </th>
                        <th style="text-align: center;background: #f26146;color:#fff;font-size: 18px;"> Microsoft 365  </th>
                        <th style="text-align: center;background: #f48874;color:#fff;font-size: 18px;">VPS</th>
                    </tr>
                    <tr>
                        <td>จำนวน Users</td>
                        <td>30</td>
                    ...
                    <tr>
                        <td>ค่าใช้จ่าย</td>
                        <td>30 x ราคา Microsoft 365 Users (รายปี) </td>
                        <td >1 x ราคาเครื่อง Server (รายปี)</td>
                    </tr>
                    <tr>
                        <td>ประสบการณ์การใช้งาน</td>
                        <td>เป็นไปตามข้อกำหนดของ Plan ต่างๆ <br> ของ Microsoft</td>
                ...
                <table class="hybrid-365-price visible-phone" style="font-family: 'Prompt', sans-serif;font-size: 17px;">
                  <tbody>
                    <tr>
                        <th style="border: none;"> </th>
                        <th  style="text-align: center;background: #f26146;font-size: 18px;color:#FFF;" > Microsoft 365  </th>
                        <th  style="text-align: center;background: #f48874;font-size: 18px;color:#FFF;">VPS</th>
                    </tr>
                    <tr>
                        <td>จำนวน Users</td>
                        <td>30</td>
                    ...
                    <tr>
                        <td>ประสบการณ์การใช้งาน</td>
                        <td>เป็นไปตามข้อกำหนดของ Plan ต่างๆ ของ Microsoft</td>
                        <td >เป็นไปตามความสามารถที่สร้างไว้เองบนเซิร์ฟเวอร์ </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div class="row " style="margin-top: 35px;"> 
                <p  class="g-txt18 gs-content hidden-phone"  style="text-align:justify;width: 83%; margin-left: 97px;"  >
                    หากคุณเลือกใช้ Microsoft 365 Business Basic สำหรับองค์กรคุณตามตัวอย่างข้างต้น จะสามารถประหยัดงบประมาณลงได้ ตามการคำนวณดังต่อไปนี้ 
                </p>
                 <p  class="g-txt18 gs-content visible-phone"  style="padding:0px;" >
                    หากคุณเลือกใช้ Microsoft 365 Business Basic สำหรับองค์กรคุณตามตัวอย่างข้างต้น จะสามารถประหยัดงบประมาณลงได้ ตามการคำนวณดังต่อไปนี้ 
                </p>
            </div>
            <div class="row " style="margin-top: 20px;"> 
               ...
               <table class="hybrid-365-price2" style="font-family: 'Prompt', sans-serif;font-size: 17px;">
                  <tr>
                   <th style="border: none;"> </th>
                    <th style="background: #f26146;text-align: center;color:#FFF;font-size: 18px;" >หากซื้อ Microsoft 365 ทั้งหมด </th>
                    <th style="background: #f48874;text-align: center;color:#FFF;font-size: 18px;" >หากซื้อโซลูชัน Hybrid Microsoft 365</th>
                  </tr>
                  <tr>
                    <td rowspan="2">จำนวน</td>
                    <td> 100 Business Basic</td>
                    <td >30 Business Basic</td>
                    
                  </tr>
                   <tr>
                    <td>-</td>
                    <td>70 Business Basic</td>  
                
                  </tr>
                  <tr>
                    <td rowspan="2">ราคาต่อหน่วย / ปี</td>
                    <td>100 Users x 1,950 บาท / ปี</td>
                    <td>30 Users x 1,950 บาท / ปี</td>
            ...
            <div class="row" style="margin-top: 70px;margin-bottom: 60px;" >       
               <div class="span11 dynamic-content" >
                   ...
                   <p  class="g-txt18 gs-content hidden-phone"  style="text-align:justify;margin-left: 50px;line-height: 28px;" >
                  การเลือกใช้ Hybrid Email Microsoft 365 สามารถใช้ภายใต้โดเมนเดียวกัน ทำให้ External Users สามารถส่งอีเมลเข้ามายังโดเมนเดียวกันขององค์กรได้ โดยไม่จำเป็นต้องแยกโดเมนเนมออก เช่น 
                   </p>
                   <p  class="g-txt16 gs-content visible-phone"  style="padding:10px;" >
                  การเลือกใช้ Hybrid Email Microsoft 365 สามารถใช้ภายใต้โดเมนเดียวกัน ทำให้ External Users สามารถส่งอีเมลเข้ามายังโดเมนเดียวกันขององค์กรได้ โดยไม่จำเป็นต้องแยกโดเมนเนมออก เช่น
                   </p>
                   <div style="text-align: center;">
                       <img  class="lazy" data-src="https://netway.co.th/templates/netwaybysidepad/images/hybrid-chart.png" style="height: auto;width: 762px;">
                   </div>
                    <p  class="g-txt18 gs-content hidden-phone"  style="text-align:justify;margin-left: 50px" >
                   โดยที่เวลาส่งออก User 1 จะส่งออกจาก Mailbox ของ Microsoft 365 และ User 2 วงออกจาก Mailbox ของเครื่อง VPS แต่ผู้รับปลายทางรับรู้ว่ามาจากโดเมนเนม @mycompany.com 
                   </p>
                   <p  class="g-txt16 gs-content visible-phone"  style="padding:10px;" >
                   โดยที่เวลาส่งออก User 1 จะส่งออกจาก Mailbox ของ Microsoft 365 และ User 2 วงออกจาก Mailbox ของเครื่อง VPS แต่ผู้รับปลายทางรับรู้ว่ามาจากโดเมนเนม @mycompany.com 
                   </p>
            ...
            <div class="row" style="margin-top: 0px;margin-bottom: 60px;" >     
               <div class="span11 dynamic-content" >
                   <p style="color: #0052cd;text-align: left; font-size: 20px;">
                        <img src="https://netway.co.th/templates/netwaybysidepad/images/hybrid-security.png" style="width: 50px;height: auto;"> 
                        Security Benefits
                        <hr class="hr-hybrid">
                   </p>
                   <p  class="g-txt18 gs-content hidden-phone"  style="text-align:justify;margin-left: 50px;line-height: 28px;" >
                   Hybrid Email Microsoft 365 ใช้มาตรการตรวจจับความปลอดภัยของ Microsoft 365 กับทุก User ภายใต้โดเมนนั้นได้ โดยจะกรองอีเมลเข้าทุกฉบับ
                   <br>ผ่านระบบความปลอดภัยของ Microsoft 365 ก่อนเสมอ จากนั้นจะเลือกส่งต่อไปยัง User ที่อยู่บน Email Server ต่างๆ ต่อไป *****
                   </p>
                   <p  class="g-txt16 gs-content visible-phone"  style="padding:10px;" >
                   Hybrid Email Microsoft 365 ใช้มาตรการตรวจจับความปลอดภัยของ Microsoft 365 กับทุก User ภายใต้โดเมนนั้นได้ โดยจะกรองอีเมลเข้าทุกฉบับ
                   <br>ผ่านระบบความปลอดภัยของ Microsoft 365 ก่อนเสมอ จากนั้นจะเลือกส่งต่อไปยัง User ที่อยู่บน Email Server ต่างๆ ต่อไป *****
                   ...
                   <div style="text-align: center;">
                       <img  class="lazy" data-src="https://netway.co.th/templates/netwaybysidepad/images/hybrid-chart2.png" style="height: auto;width: 965px;">
                   </div>
                    <p  class="g-txt18 gs-content hidden-phone"  style="text-align:justify;margin-left: 50px" >
                   ***** ในกรณีที่ MX record อยู่ที่ Microsoft 365 เท่านั้น โดยปริมาณความเหมาะสมตามจำนวน User ของทั้ง 2 Server  
                   </p>
                    <p  class="g-txt16 gs-content visible-phone"  style="padding:10px;" >
                   ***** ในกรณีที่ MX record อยู่ที่ Microsoft 365 เท่านั้น โดยปริมาณความเหมาะสมตามจำนวน User ของทั้ง 2 Server  
                   </p>
    ...
    <div class="row-fluid " id="PlanandPricing" style="margin-top: 0px;"> 
            ...
            <div class="row">
                <div class="span12 dynamic-content">
                    ...
                    <p class="g-txt18 hidden-phone" style="margin: 38px 0px;line-height: 28px;">
                        Hybrid Email Microsoft 365 สามารถเริ่มต้นที่ 2 Users ขึ้นไปโดยพิจารณาจากสัดส่วนของจำนวน Users ที่อยู่บนแต่ละเครื่องเป็นสำคัญ แนะนำให้ติดต่อเจ้าหน้าที่ฝ่ายขายและแจ้งจำนวน Users ทั้งหมดที่ท่านต้องการใช้ หรือสามารถเลือกจากแพ็คเกจต่อไปนี้ได้ 
                    </p>
                    <p class="g-txt16 gs-content visible-phone" style="margin-top: 15px; line-height: normal;padding: 10px;">
                        Hybrid Email Microsoft 365 สามารถเริ่มต้นที่ 2 Users ขึ้นไปโดยพิจารณาจากสัดส่วนของจำนวน Users ที่อยู่บนแต่ละเครื่องเป็นสำคัญ แนะนำให้ติดต่อเจ้าหน้าที่ฝ่ายขายและแจ้งจำนวน Users ทั้งหมดที่ท่านต้องการใช้ หรือสามารถเลือกจากแพ็คเกจต่อไปนี้ได้
                    </p>    
                </div>
            </div>
                                   ...
                                   <div class="row " style="font-family: 'Prompt', sans-serif;">  
                                        <div class="span3">
                                            ...
                                            <div class="plan-gs" style="height: 330px; text-align: center; padding: 12px 20px 0px 20px;border-radius: 0 0 10px 10px;">
                                                ...
                                                <table class="table-hover" style="color: #434343; width:100%;  font-size: 16px; text-align: left;">
                                                    ...
                                                    <tr>
                                                    <td style="padding: 5px 0 5px 0;">ที่ยังต้องการความคล่องตัวในการสลับไปมาระหว่าง Microsoft 365 และ  Email Server ทั่วไป</td>
                                        ...
                                        <div class="span3"> 
                                           <table class="hidden-phone">
                                            ...
                                            <div class="plan-gs" style="height: 330px; text-align: center; padding: 12px 20px 0px 20px;border-radius: 0 0 10px 10px;">    
                                                <p class="color-blue-s txt-price-top" style="margin-bottom: 5px;font-size: 31px;">101-500 Users</p>
                                                ...
                                                <tr>
                                                <td style="padding: 5px 0 5px 0;s">ที่มองหาโซลูชันที่ตอบโจทย์งบประมาณที่แปรผันตามปีโดยสามารถเปลี่ยน  Email Server ได้อย่างคล่องตัว</td>
                                                </tr>
                                                </tbody>
                                                </table>
                                                <hr style="margin-top: 0px;  margin-bottom: 0px;">      
                                                <a href="https://support.netway.co.th/hc/th/requests/new?ticket_form_id=114093963072&request_subject=%E0%B8%82%E0%B8%AD%E0%B8%82%E0%B9%89%E0%B8%AD%E0%B8%A1%E0%B8%B9%E0%B8%A5%E0%B9%80%E0%B8%9E%E0%B8%B4%E0%B9%88%E0%B8%A1%E0%B9%80%E0%B8%95%E0%B8%B4%E0%B8%A1%E0%B9%81%E0%B8%A5%E0%B8%B0%E0%B8%A3%E0%B8%B2%E0%B8%84%E0%B8%B2%20Solution%20Hybrid%20Office%20365/G%20Suite" target="_blank">
                                                <button class="btn-buy " style="margin-top: 9px;margin-bottom: 10px;padding: 12px;">ขอใบเสนอราคา<i class="fa fa-chevron-right" aria-hidden="true"></i></button>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="span3"> 
                                            ...
                                            <div class="plan-gs" style="height: 330px; text-align: center; padding: 12px 20px 0px 20px;border-radius: 0 0 10px 10px;">  
                                                ...
                                                <hr style="margin-top: 0px;  margin-bottom: 0px;">      
                                                <a href="https://support.netway.co.th/hc/th/requests/new?ticket_form_id=114093963072&request_subject=%E0%B8%82%E0%B8%AD%E0%B8%82%E0%B9%89%E0%B8%AD%E0%B8%A1%E0%B8%B9%E0%B8%A5%E0%B9%80%E0%B8%9E%E0%B8%B4%E0%B9%88%E0%B8%A1%E0%B9%80%E0%B8%95%E0%B8%B4%E0%B8%A1%E0%B9%81%E0%B8%A5%E0%B8%B0%E0%B8%A3%E0%B8%B2%E0%B8%84%E0%B8%B2%20Solution%20Hybrid%20Office%20365/G%20Suite" target="_blank">
                                                <button class="btn-buy " style="margin-top: 11px;margin-bottom: 10px;padding: 12px;">ขอใบเสนอราคา<i class="fa fa-chevron-right" aria-hidden="true"></i></button>
                                                </a>
                                            </div>
                                        </div>
                                      </div>   
        ...
        </div><!-- end Plan & Pricing o365 -->
</div> 
 
<div class="row-fluid hidden" id='hybrid-gsuite' > 
    <div class="row-fluid" style="margin-top: 80px;" id="FeatureGsuite" >
        <div class="span12 dynamic-content" >
            <center>
                <h3 class="h3-title-content g-txt32 re-topic" >
    ...
    <div class="row-fluid " id="PlanandPricingGsuite" style="margin-top: 0px;"> 
        <div class="container" style="margin-top: 65px; margin-bottom: 10px;">         
            <div class="row">
                <div class="span12 dynamic-content">
                    <center>
