    ...
    <div class="row-fluid"> 
      <div class=" hybrid365  ">
              <div class="container">       
                ...
                <div class="span6 hero-inner visible-phone" >
                     <img src="https://netway.co.th/templates/netwaybysidepad/images/hybrid-banner.png"  alt="" style="width: 200px;margin-top:-16px;">
        ...
        <div class="dynamic-menu hidden-phone  container " style="background-color: #4489FF; width: 100%;">
            <div  class="container">
                <ul class="dynamic-nav ">
                    <li class="dynamic-nav"><a class="dynamic-nav nav-Features active" href="#Feature">Feature </a></li>
                    <li class="dynamic-nav"><a class="dynamic-nav nav-PlanandPricing" href="#PlanandPricing">Plan and  Pricing</a></li>
                    <li class="dynamic-nav"><a class="dynamic-nav nav-faq" href="#faq">FAQ</a></li>
                    <li class="dynamic-nav hidden"><a class="dynamic-nav nav-datasheet" href="#empty"></a></li> 
                </ul>
             </div>
        </div>
    </section>
            ...
            <div class="row" style="margin-top: 70px;margin-bottom: 60px;" >       
               <div class="span11 dynamic-content" >
                  ...
                  การเลือกใช้ Hybrid Email Microsoft 365 สามารถใช้ภายใต้โดเมนเดียวกัน ทำให้ External Users สามารถส่งอีเมลเข้ามายังโดเมนเดียวกันขององค์กรได้ โดยไม่จำเป็นต้องแยกโดเมนเนมออก เช่น
                   ...
                   โดยที่เวลาส่งออก User 1 จะส่งออกจาก Mailbox ของ Microsoft 365 และ Users 2 วงออกจาก Mailbox ของเครื่อง VPS แต่ผู้รับปลายทางรับรู้ว่ามาจากโดเมนเนม @mycompany.com 
                   </p>
                   <p  class="g-txt16 gs-content visible-phone"  style="padding:10px;" >
                   โดยที่เวลาส่งออก User 1 จะส่งออกจาก Mailbox ของ Microsoft 365 และ Users 2 วงออกจาก Mailbox ของเครื่อง VPS แต่ผู้รับปลายทางรับรู้ว่ามาจากโดเมนเนม @mycompany.com 
                   </p>
