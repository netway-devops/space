...
<div class="brcrm">
    <ul class="breadcrumb left">
        <li><a href="{$ca_url}profiles/&act={$act}"><strong>{$lang.profiles}</strong></a> <span class="divider">/</span></li>
...
<form id="formEditContact" method="post" action="" >
    ...
    <p class="add-contact pl19">{$lang.contactdetails} {if $act == 'emailcontact'} <span class="divider">/</span> <span class="active">Email service notification</span> {/if}</p>
    
    {if $act}
    
    {if $act == 'emailcontact'}
    
    {include file="contacts/contact_notify.tpl"}
    ...
    {include file="contacts/contact_address.tpl"}
