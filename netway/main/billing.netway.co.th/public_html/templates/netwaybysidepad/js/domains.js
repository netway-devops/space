...
function addToSelectedDomainItems (el)
{
	var v	= $(el);
	$('#selectedDomainEnd').show();
	$('#selectedDomainItems').show();
	v.attr('onclick', '');
	$('#selectedDomainItems').after(v.parent().parent());
	$('html, body').animate({ scrollTop: $('#selectedDomainItems').offset().top}, 500);
}