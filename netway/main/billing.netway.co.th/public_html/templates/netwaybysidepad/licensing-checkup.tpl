...
<section id="customTab" style="margin-top: 0px;   background-color:#4489FF;">
        <div class="dynamic-menu hidden-phone  container " style="background-color: #4489FF; width: 100%;">
           <div class="container">
            <ul class="dynamic-nav " >
                ...
                <li class="dynamic-nav"><a class="dynamic-nav " href="#feture" >Feture</a></li>
                <li class="dynamic-nav"><a class="dynamic-nav " href="#plan">Plan and pricing</a></li>
                <li class="dynamic-nav"><a class="dynamic-nav " href="#promo">PROMO</a></li>     
                <li class="dynamic-nav"><a class="dynamic-nav " href="#faq">FAQ</a></li> 
                <li class="dynamic-nav"><a class="dynamic-nav " href="#datasheet">DATASHEET</a></li> 
                <li class="dynamic-nav"><a class="dynamic-nav " href="#servicerequest">SERVICEREQUEST</a></li> 
  ...
  <div class="row-fluid" id="feture"  style="background-color: #fff;"> 
      <div class="container"style="padding: 125px 10px 70px 10px;" >         
            <div class="row">
 ...
 <div class="row-fluid white-kb-2018" id="Authorized">
  ...
  <div class="row-fluid  bg-gs-pricing" id="plan"> 
        <div class="container" > 
            <div class="row">
               <div class="span12 dynamic-content"   >
             <center><h3 class="h3-title-content g-txt32 re-topic">
          ...
          <div class="container" >         
                <div class="row-fluid " >
                  <div class="span3">
                     <div class="sale-gs"style="background-color: #df4012;font-size: 24px;" >
                         <h3 style="color: #FFF;margin-top: 0px;">
                             1-30 PC
                        </div>
                      <div class="plan-gs"style="height: 500px;padding: 40px 18px;" >   
                           <div class="pricing">                  
                                <p class="info-gs-2 g-txt16"> License Check-up 30 max</p>
                                <p class="info-gs-2 g-txt16">บริการตรวจเช็คความถูกต้องของ Microsoft License สำหรับองค์กรจำนวน 1-30 PC</p>
                                 <p class="info-gs-2 g-txt16">ตรวจสอบด้วยโปรแกรม MAP Toolkit</p>
                                 <p class="info-gs-2 g-txt16">รองรับ Cloud Auditing</p>
                                <p class="info-gs-2 g-txt16"> รับรองผลถูกต้อง 100%</p>
                                 <br/>
                                <div class="span12 gs-price" style="text-align: center;">
                                    <span class="font-sale g-txt36" >4,700 บาท</span>
                                </div>     
                                 <p class="price-bill">(ราคานี้ยังไม่รวมภาษี 7%)</p> 
                            </div>
                        </div>
                  </div>
                  <div class="span3">
                    <div class="sale-gs"style="background-color: #6da105;font-size: 24px;"  >
                         <h3 style="color: #FFF;margin-top: 0px;">  
                              31-75 PC  
                          </h3>
                      </div>
                      <div class="plan-gs"style="height: 500px;padding: 40px 18px;" >
                           <div class="pricing">
                                ...
                                <p class="info-gs-2 g-txt16"> License Check-up 75 max</p>
                                <p class="info-gs-2 g-txt16">บริการตรวจเช็คความถูกต้องของ Microsoft License สำหรับองค์กรจำนวน 31-75 PC</p>
                                 <p class="info-gs-2 g-txt16">ตรวจสอบด้วยโปรแกรม MAP Toolkit</p>
                                 <p class="info-gs-2 g-txt16">รองรับ Cloud Auditing</p>
                                <p class="info-gs-2 g-txt16"> รับรองผลถูกต้อง 100%</p>
                                <br/>
                                <div class="span12 gs-price"style="text-align: center;">
                                    <span class="font-sale g-txt36" >9,500 บาท</span>
                                </div>     
                                 <p class="price-bill">(ราคานี้ยังไม่รวมภาษี 7%)</p> 
                            </div>
                        </div>
                  ...
                  <div class="span3">
                    <div class="sale-gs"style="background-color: #2590e7;font-size: 24px;"  >
                       <h3 style="color: #FFF;margin-top: 0px;">  
                             76-200 PC  
                          </h3>  
                    </div>
                      <div class="plan-gs"style="height: 500px;padding: 40px 18px;" >
                           <div class="pricing">
                                ...
                                <p class="info-gs-2 g-txt16"> License Check-up 200 max</p>
                                <p class="info-gs-2 g-txt16">บริการตรวจเช็คความถูกต้องของ Microsoft License สำหรับองค์กรจำนวน 76-200 PC</p>
                                 <p class="info-gs-2 g-txt16">ตรวจสอบด้วยโปรแกรม MAP Toolkit และ/หรือ System Center Configuration Manager</p>
                                 <p class="info-gs-2 g-txt16">รองรับ Cloud Auditing</p>
                                <p class="info-gs-2 g-txt16"> รับรองผลถูกต้อง 100%</p>
                              
                                <div class="span12 gs-price"style="text-align: center;">
                                    <span class="font-sale g-txt36" >14,500 บาท</span>
                                </div>     
                                 <p class="price-bill">(ราคานี้ยังไม่รวมภาษี 7%)</p> 
                            </div>
                        </div>
                  ...
                  <div class="span3">
                    <div class="sale-gs"style="background-color: #eda606;font-size: 24px;"  > 
                        <h3 style="color: #FFF;margin-top: 0px;">  
                            201-250 PC 
                          </h3>  
                    </div> 
                      <div class="plan-gs"style="height: 500px;padding: 40px 18px;" >
                           <div class="pricing">
                                <p class="info-gs-2 g-txt16"> License Check-up 250 max</p>
                                <p class="info-gs-2 g-txt16">บริการตรวจเช็คความถูกต้องของ Microsoft License สำหรับองค์กรจำนวน 201-250 PC</p>
                                 <p class="info-gs-2 g-txt16">ตรวจสอบด้วยโปรแกรม MAP Toolkit และ/หรือ System Center Configuration Manager</p>
                                 <p class="info-gs-2 g-txt16">รองรับ Cloud Auditing</p>
                                <p class="info-gs-2 g-txt16"> รับรองผลถูกต้อง 100%</p>
                                
                                <div class="span12 gs-price"style="text-align: center;">
                                    <span class="font-sale g-txt36" >23,500 บาท</span>
                                </div>     
                                 <p class="price-bill">(ราคานี้ยังไม่รวมภาษี 7%)</p> 
                            </div>
                        </div>
  ...
  <div class=class="row-fluid" id="promo" > 
      <div class="container"style= "padding: 70px 10px 70px 10px;" >
           <div class="row">
