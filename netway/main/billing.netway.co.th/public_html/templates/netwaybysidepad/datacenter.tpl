      ...
      <div class="container" >      
          <div class="row">
             <div class="span6" style="border-right: 2px solid #0052cd;">
                   ...
                   <hr/>
                   <div class="g-txt16" style="line-height: 24px; text-align: justify; padding: 0 25px 0 0px;">
                     <p>                     
                                          ตั้งอยู่ที่  <b>ProEN Internet Datacenter ชั้น 18 อาคาร กสท โทรคมนาคม บางรัก </b> ซึ่งเป็นอาคารที่ตั้งของระบบ International Internet Gateway (IIG) และ National Internet Exchange (NIX) ของประเทศไทย 
                                          โดย	เป็นศูนย์กลางการแลกเปลี่ยนข้อมูลอินเทอร์เน็ตระหว่างประเทศ (National Internet Gateway) และ
                     </p>
                     <p><font color="red">มี Domestic Bandwidth ที่มากที่สุดในประเทศไทย สูงถึง 700 Gbps </font> </p>
                     <p>ที่ใหญ่ที่สุดในประเทศไทย เพียบพร้อมด้วยสิ่งอำนวยความสะดวกที่ครบครัน ตลอดจนระบบเครือข่ายและระบบรักษาความปลอดภัย 	รวมถึงการเชื่อมต่อเครือข่ายอินเทอร์เน็ตที่สมบูรณ์แบบ เพื่อตอบสนองการใช้งานได้ครบทุกความต้องการ  ทาง Netway เลือกใช้บริการของ ProEN Internet Datacenter เพราะได้รับการรับรองมาตรฐาน </p> 
                    </div>                      
                     ...
                     <p class="g-txt16" style="line-height: 24px; text-align: justify; margin-top: 10px; padding: 0 25px 0 0px;">
                                               อันทำให้มั่นใจได้ในการป้องกันข้อมูลส่วนบุคคลของลูกค้าเราในห้อง Internet Data Center และการบริหารจัดการอย่างเป็นระบบ มีคุณภาพ มีการควบคุมตรวจสอบได้ ตามมาตรฐานที่ได้รับการรับรองมา ซึ่งทำให้ลูกค้าของ Netway มีความปลอดภัยในด้านข้อมูลการเข้าถึง และระบบสามารถทำงานได้อย่างมีประสิทธิภาพ 
                     </p>
             ...
             <div class="span6">
                 <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3875.8638937936007!2d100.51211131468631!3d13.726688990363732!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e298db0a8b5b0b%3A0x5291d408c0b0a394!2sPROEN+INTERNET+DATA+CENTER!5e0!3m2!1sen!2sth!4v1548244008271" width="600" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
                  ...
                  <div style="display: none;">
	                  ...
	                  <hr/>
	                  <a href="#" target="_blank"  style=""><img src="https://support.netway.co.th/hc/article_attachments/360013660131/download.png" alt="download.png"></a>
	                  </center>
                  </div>
             </div>
      </div>
