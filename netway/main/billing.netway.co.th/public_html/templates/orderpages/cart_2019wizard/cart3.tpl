            ...
            <form action="" method="post" id="cart3">
                ...
                {if $product.description!='' || $product.paytype=='Once' || $product.paytype=='Free'}
                    <div class="card shadow p-4">
                        <h3 class="mb-4 text-primary pb-3 border-bottom">{$product.name}</h3>
                ...
                <div class="card shadow p-4">
                    <h3 class="mb-4 text-primary pb-3 border-bottom">{$lang.config_options}</h3>
                    <div class="card-body p-0">
                            {if $product.paytype!='Once' && $product.paytype!='Free'}
                                <dl class="row align-items-center">
                                    ...
                                    <dd class="col-md-9 col-12 ">
                                        <select class="form-control" name="cycle" onchange="{if $custom}changeCycle('#cart3');{else}simulateCart('#cart3');{/if}">
                                            {price product=$product}
                            ...
                            {if $custom}
                                ...
                                {foreach from=$custom item=cf}
                                    {if $cf.items}
                                        <div class="form-group my-3 py-2 border-bottom cart-form cart-item {if $cf.key|strstr:'cf_'}{$cf.key} cf_option{/if}">
                ...
                {if $addons}
                <div class="card shadow p-4">
                    <h3 class="mb-4 text-primary pb-3 border-bottom">{$lang.addons_single}</h3>
                    <div class="card-body p-0">
