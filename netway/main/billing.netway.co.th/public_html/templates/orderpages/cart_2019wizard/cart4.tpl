<div class="orderpage orderpage-cart_2019wizard">
    ...
    <div class="cards-cart">
        <div class="card shadow p-4">
            <div class="d-flex flex-column flex-md-row flex-grow-1 align-items-start justify-content-md-between">
                <h3 class="mb-4 text-primary pb-3  flex-grow-1 border-bottom">{$lang.ordersummary}</h3>
                {if count($currencies) > 1 }
                    <form action="" method="post" id="currform" class="d-flex flex-row align-items-center ml-3 align-items-center">
            ...
            <div class="card-body p-0">
                <table class="checker table table-borderless w-100">
                    <tbody>
                        <tr>
                            <td class="text-muted" width="55%" align="left">{$lang.Description}</td>
                            <td class="text-muted" width="20%"> {$lang.setupfee}</td>
                            <td class="text-muted" width="25%">{$lang.price}</td>
                        </tr>
                    </tbody>
                    <tbody>
                    {if $product}
    ...
    <form action="" method="post">
        ...
        {if $gateways}
            <div class="card shadow p-4" style="display: none;" id="gatewayform">
                <div class="card-body p-0">
                    <div>{$gatewayhtml}</div>
                </div>
            </div>
        ...
        <div class="d-flex flex-row align-items-center justify-content-center my-5">
            <input type="submit" value="{$lang.clear_cart}" name="clear" class="btn btn-default btn-lg w-25 mx-2"/>
            <input type="submit" value="{$lang.checkout}" name="submit" class="btn btn-primary btn-lg w-25 mx-2"/>
        </div>
    </form>
</div>