...
$curyear = $this->get_template_vars('curyear');
$supportedcc = $this->get_template_vars('supportedcc');
?>
<div class="wbox">
    <div class="wbox_header">
        <strong><?php echo $lang['ccarddetails'];?></strong>
    </div>
    <div class="wbox_content ccform">
        <div class="left citm">
            <label for="field_credit_holder">Card Holder Name</label>
            <input type="text" id="field_credit_holder" class="styled" name="cc[cardholder]" style="width: 90%;" value=""  autocomplete="off" />
        </div>
        <div class="left citm">
            <label for="field_credit_number"><?php echo $lang['ccardnum'];?></label>
        ...
        <div class="left cfitm" style="padding-bottom:3px">
            <label for="field_credit_number"><?php echo $lang['ccardexp'];?></label>
            <select name="cc[expirymonth]"id="field_expirymonth" class="styled span1"> <option value="01">01</option>
                ...
                <option value="12">12</option></select> / <select name="cc[expiryyear]" id="field_expiryyear"class="styled span1">
                	<? 
        ...
        <div class="left cfitm">
            <label for="field_credit_cvv">CVV2</label>
            <input type="text" id="field_credit_cvv" class="styled" name="cc[cvv]" style="width:50px" value=""  autocomplete="off" />
        </div>
        <div class="left cfitm" id="card_types">

            <input type="hidden" id="field_credit_type"  name="cc[cardtype]"  value="" />
            <label for="field_credit_number"><?php echo $lang['ccardtypeaccept'];?></label>
            <?php
                foreach ($supportedcc as $cc){ ?>
                <div class="credit_card <?php echo $cc;?>" title="<?php echo $cc;?>"></div>
            <?php } ?>
