...
<section class="section-invoices">
    ...
    <a href="{$ca_url}clientarea/creditreceipts/" id="currentlist" style="display:none" updater="#updater"></a>
    ...
    <div class="table-responsive table-borders table-radius">
        <table class="table invoices-table position-relative stackable">
            ...
            <tr>
                ...
                {/if}
                <th><a href="{$ca_url}clientarea&amp;action=creditreceipts&amp;orderby=id|ASC" data-sorter="orderby"><i class="material-icons size-sm sort-icon">unfold_more</i>{$lang.creditreceipt}</a></th>
                <th><a href="{$ca_url}clientarea&amp;action=creditreceipts&amp;orderby=status|ASC"  data-sorter="orderby"><i class="material-icons size-sm sort-icon">unfold_more</i>{$lang.status}</a></th>
                <th><a href="{$ca_url}clientarea&amp;action=creditreceipts&amp;orderby=total|ASC"  data-sorter="orderby"><i class="material-icons size-sm sort-icon">unfold_more</i>{$lang.total}</a></th>
                <th><a href="{$ca_url}clientarea&amp;action=creditreceipts&amp;orderby=date|ASC"  data-sorter="orderby"><i class="material-icons size-sm sort-icon">unfold_more</i>{$lang.invoicedate}</a></th>
                <th  class="noncrucial"><a href="{$ca_url}clientarea&amp;action=creditreceipts&amp;orderby=duedate|ASC"  data-sorter="orderby"><i class="material-icons size-sm sort-icon">unfold_more</i>{$lang.duedate}</a></th>
