...
{if $tpl_config.gtm_send_to}
    {literal}
        <script>
            if (typeof gtag !== "undefined") {
                gtag('event', 'conversion', {
                    'send_to': {/literal}'{$tpl_config.gtm_send_to}'{literal},
                    'value': {/literal}'{$invoice.total}{literal}',
                    'currency': {/literal}'{$invoice.currency.iso}'{literal},
                    'transaction_id': {/literal}'{$invoice.id}'{literal}
                });
            }
        </script>
    {/literal}
