...
<div class="cart">
            ...
            <div class="card-body">
                <table class="checker table stackable table-borderless w-100">
                    <thead class="thead-transparent">
                        <tr class="d-none d-md-table-row hidden">
                            ...
                            {if $order.product}
                                <tr>
                                    ...
                                    <td data-label="{$lang.price}" class="font-weight-bold">
                                        {if $order.product.price==0}{$lang.FreeSummary}
                                        ...
                                        {if $cstom.total>0}
                                            <tr >
                                                ...
                                                <td data-label="{$lang.price}">
                                                    {if $cstom.price==0}{$lang.FreeSummary}
                            ...
                            {if $order.addons}
                                {foreach from=$order.addons item=addon}
                                    <tr >
                                        ...
                                        <td data-label="{$lang.price}">
                                            {if $addon.price==0}{$lang.FreeSummary}
                            ...
                            {if $order.subproducts}
                                {foreach from=$order.subproducts item=subprod}
                                    <tr class="srow">
                                        ...
                                        <td data-label="{$lang.price}">
                                            {if $subprod.price==0}<strong>{$lang.FreeSummary}</strong>
    ...
    <form action="{$ca_url}cart" method="post">
        ...
        <div class="card" {if $tax && $tax.total==0}style="display:none"{elseif $credit && $credit.total==0}style="display:none"{elseif $subtotal.total==0}style="display:none"{/if}>
            <div class="card-header">
        ...
        <div class="row my-5">
            <div class="col-12 col-sm-6 col-md-4 offset-md-2 mb-2 mb-sm-0">
                <a href="?cmd=products" class="btn btn-lg btn-outline-light border border-primary text-primary w-100 d-flex flex-row align-items-center justify-content-center">
                    <i class="material-icons size-md mr-2">add_shopping_cart</i>
                    {$lang.continue_shopping|default:"Continue shopping"}
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
                <button class="btn btn-primary border border-primary btn-lg d-flex flex-row align-items-center justify-content-center w-100" type="submit" name="submit" value="{$lang.checkout}">
