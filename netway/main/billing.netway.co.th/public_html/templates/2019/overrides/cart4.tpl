                        ...
                        <tr>
                            ...
                            <td class="font-weight-bold">
                                {if $contents[0].price==0}
                                    <strong>{$lang.FreeSummary}</strong>
                            ...
                            {foreach from=$cstom2 item=cstom}
                                {if $cstom.total>0}
                                    <tr>
                                        ...
                                        <td>
                                            <strong>{if $cstom.price==0}{$lang.FreeSummary}{elseif $cstom.prorata_amount}{$cstom.prorata_amount|price:$currency}{else}{$cstom.price|price:$currency}{/if}</strong>
                                        </td>
                                    </tr>
                                {/if}
                            {/foreach}
